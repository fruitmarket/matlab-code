...
if isempty(drawingFigHandle)
    ...
    drawingFigHandle = ...
        ...
        'Position',MClust_CHDrawingAxisWindow_Pos);
    set(drawingFigHandle,'KeyPressFcn',@Shortcuts);%,'Callback', 'MClustCutterCallbacks');
else
...
% Coded added by Jaeeon Lee. 2015.06.07

% Add menus with Accelerators
fig=drawingFigHandle;
hManager = uigetmodemanager(fig);
if ~isempty(hManager.CurrentMode)
    hManager.CurrentMode.KeyPressFcn=@Shortcuts;    
    hManager.CurrentMode.WindowKeyPressFcn=@Shortcuts;
end
