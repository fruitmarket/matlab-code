...
%
% The largest of these deviations (between empirical distribution and unimodal distribution that the test created) is the dip statistic.	
% The dipstatistic tells you the probability of the empirical distribution function being bimodal. 
% By having a large value dip, the empirical data is more probable to have multiple modes.
% https://www.uah.edu/images/administrative/Honors/Papers/v03n2-Stanbro.pdf
