function [result_RMAOV1] = RMAOV1(X,alpha)
...
result_RMAOV1 = cell(5,6);
result_RMAOV1{1,1} = 'SOV';
result_RMAOV1{2,1} = 'Subjects';
result_RMAOV1{3,1} = 'IV';
result_RMAOV1{4,1} = 'Error';
result_RMAOV1{5,1} = 'Total';

result_RMAOV1{1,2} = 'SS';
result_RMAOV1{2,2} = SSS;
result_RMAOV1{3,2} = SSA;
result_RMAOV1{4,2} = SSE;
result_RMAOV1{5,2} = SST;

result_RMAOV1{1,3} = 'df';
result_RMAOV1{2,3} = v2;
result_RMAOV1{3,3} = v1;
result_RMAOV1{4,3} = v3;
result_RMAOV1{5,3} = dfT;

result_RMAOV1{1,4} = 'MS';
result_RMAOV1{2,4} = MSS;
result_RMAOV1{3,4} = MSA;
result_RMAOV1{4,4} = MSE;

result_RMAOV1{1,5} = 'F';
result_RMAOV1{2,5} = F2;
result_RMAOV1{3,5} = F1;


result_RMAOV1{1,6} = 'P';
result_RMAOV1{2,6} = P2;
result_RMAOV1{3,6} = P1;
