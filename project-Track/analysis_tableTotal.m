...
l_PF_outField_act = sum(double((T.taskType == 'DRun' | T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeIn == 1));
l_PF_outField_ina = sum(double((T.taskType == 'DRun' | T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeIn == -1));
l_PF_outField_no = sum(double((T.taskType == 'DRun' | T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeIn == 0));
nol_PF_outField_act = sum(double((T.taskType == 'noRun' | T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeIn == 1));
nol_PF_outField_ina = sum(double((T.taskType == 'noRun' | T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeIn == -1));
nol_PF_outField_no = sum(double((T.taskType == 'noRun' | T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeIn == 0));
