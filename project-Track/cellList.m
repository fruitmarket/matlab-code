...
T = table();
for iFile = 1:nFile
    load(matFile{iFile},'meanFR_base','meanFR_task','meanFR_pre','meanFR_stm','meanFR_post','burstIdx','spkwv','spkwth','hfvwth','ina_lastSpk_tag','ina_firstSpk_tag','ina_lastSpk_modu','ina_firstSpk_modu',...
        'pLR_tag','pLR_modu','pSaltTag','pSaltModu','statDir_tag','statDir_modu','testLatencyModu_first','testLatencyModu_second',...                                         % From tagstatTrack
    ...
    temT = table(mouseLine,taskType,matFile(iFile),taskProb,meanFR_base,meanFR_task,meanFR_pre,meanFR_stm,meanFR_post,burstIdx,{spkwv},spkwth,hfvwth,ina_lastSpk_tag,ina_firstSpk_tag,ina_lastSpk_modu,ina_firstSpk_modu,...
        pLR_tag,pLR_modu,pSaltTag,pSaltModu,statDir_tag,statDir_modu,testLatencyModu_first,testLatencyModu_second,...
        ...
        'VariableNames',{'mouseLine','taskType','Path','taskProb','meanFR_base','meanFR_task','meanFR_pre','meanFR_stm','meanFR_post','burstIdx','spkwv','spkwth','hfwth','ina_lastSpk_tag','ina_firstSpk_tag','ina_lastSpk_modu','ina_firstSpk_modu',...
        'pLR_tag','pLR_modu','pSaltTag','pSaltModu','statDir_tag','statDir_modu','testLatencyModu_first','testLatencyModu_second',...
        'testLatencyTag_first','testLatencyTag_second','baseLatencyModu','baseLatencyTag','pLatencyModu_first','pLatencyModu_second','pLatencyTag_first','pLatencyTag_second',...
        'lightSpk','lightPreSpk','lightPostSpk','psdPreSpk','psdPostSpk','lighttagSpk','lighttagPreSpk','lighttagPostSpk','intraLightDir','interLightDir','tagLightDir',...
        'r_Corrbfxaft','r_Corrbfxdr','r_Corrdrxaft','r_Corrhfxhf','r_CorrEvOd','p_Corrbfxaft','p_Corrbfxdr','p_Corrdrxaft','p_Corrhfxhf','p_CorrEvOd'});
