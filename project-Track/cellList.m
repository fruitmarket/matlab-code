...
T = table();
for iFile = 1:nFile
    load(matFile{iFile},'fr_base','fr_task','burstIdx','spkwv','spkwth','hfvwth','p_tag','p_modu','p_saltTag','p_saltModu','tagRatio','moduRatio','ntagLightspk','nmoduLightspk',...
    ...
    temT = table(mouseLine,taskType,matFile(iFile),taskProb,fr_base,fr_task,burstIdx,{spkwv},spkwth,hfvwth,p_tag,p_modu,p_saltTag,p_saltModu,tagRatio,moduRatio,ntagLightspk,nmoduLightspk,...
        r_Corrbfxaft,r_Corrbfxdr,r_Corrdrxaft,r_Corrhfxhf,p_Corrbfxaft,p_Corrbfxdr,p_Corrdrxaft,p_Corrhfxhf,...
