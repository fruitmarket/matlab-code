...
T = table();
for iFile = 1:nFile
    load(matFile{iFile},'fr_base','fr_task','meanFR_pre','meanFR_stm','meanFR_post','burstIdx','spkwv','spkwth','hfvwth','p_tag','p_modu','p_saltTag','p_saltModu',...
    ...
    temT = table(mouseLine,taskType,matFile(iFile),taskProb,fr_base,fr_task,meanFR_pre,meanFR_stm,meanFR_post,burstIdx,{spkwv},spkwth,hfvwth,p_tag,p_modu,p_saltTag,p_saltModu,...
        lightDir_tag,lightDir_modu,latency_tag,latency_modu,...
        lightSpk,lightPreSpk,lightPostSpk,psdPreSpk,psdPostSpk,lighttagSpk,lighttagPreSpk,lighttagPostSpk,intraLightDir,interLightDir,tagLightDir,...
        r_Corrbfxaft,r_Corrbfxdr,r_Corrdrxaft,r_Corrhfxhf,r_CorrEvOd,p_Corrbfxaft,p_Corrbfxdr,p_Corrdrxaft,p_Corrhfxhf,p_CorrEvOd,...
        'VariableNames',{'mouseLine','taskType','Path','taskProb','fr_base','fr_task','meanFR_pre','meanFR_stm','meanFR_post','burstIdx','spkwv','spkwth','hfwth','p_tag','p_modu','p_saltTag','p_saltModu',...
        'lightDir_tag','lightDir_modu','latency_tag','latency_modu',...
        'lightSpk','lightPreSpk','lightPostSpk','psdPreSpk','psdPostSpk','lighttagSpk','lighttagPreSpk','lighttagPostSpk','intraLightDir','interLightDir','tagLightDir',...
        'r_Corrbfxaft','r_Corrbfxdr','r_Corrdrxaft','r_Corrhfxhf','r_CorrEvOd','p_Corrbfxaft','p_Corrbfxdr','p_Corrdrxaft','p_Corrhfxhf','p_CorrEvOd'});
