...
% analysis_spatialRaster50hz_pvCorr
    ...
    temT = table(path,cellID,sessionOrder,taskType,tetLocation,meanFR_base,meanFR_task,meanFR_pre,meanFR_stm,meanFR_post,burstIdx,...    % event2mat, pethSensor (droped preTime, stmTime, postTime)
        ...
        idxNeurontype,idxPeakFR,idxPlaceField,idxTotalSpikeNum,idxpLR_Track,idxpLR_Plfm8hz,idxmFrIn,idxmFrOut,idxmFrTotal,idxOverLap,idxZoneInOut,idxZoneInOutPRE,overLapLength);
    T = [T; temT];
