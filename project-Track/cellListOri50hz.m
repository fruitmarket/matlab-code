...
% analysis_spatialRaster50hz_pvCorr
    ...
    temT = table(path,cellID,taskType,tetLocation,meanFR_base,meanFR_task,meanFR_pre,meanFR_stm,meanFR_post,burstIdx,...    % pethSensor
        ...
        idxNeurontype,idxPeakFR,idxPlaceField,idxTotalSpikeNum,idxpLR_Track,idxpLR_Plfm50hz,idxmFrIn,idxmFrOut,idxmFrTotal,idxOverLap,idxZoneInOut,overLapLength);
    T = [T; temT];
