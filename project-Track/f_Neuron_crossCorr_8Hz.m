...
r_PRExPRE_Run = T.rCorr1D_preXpre(tPC_DRun);
r_PRExSTIM_Run = T.rCorr1D_preXstm(tPC_DRun);
r_PRExPOST_Run = T.rCorr1D_preXpost(tPC_DRun);
r_STIMxPOST_Run = T.rCorr1D_stmXpost(tPC_DRun);
...
r_PRExPRE_Rw = T.rCorr1D_preXpre(tPC_DRw);
r_PRExSTIM_Rw = T.rCorr1D_preXstm(tPC_DRw);
r_PRExPOST_Rw = T.rCorr1D_preXpost(tPC_DRw);
r_STIMxPOST_Rw = T.rCorr1D_stmXpost(tPC_DRw);
...
r_PRExPRE_noRun = T.rCorr1D_preXpre(tPC_noRun);
r_PRExSTIM_noRun = T.rCorr1D_preXstm(tPC_noRun);
r_PRExPOST_noRun = T.rCorr1D_preXpost(tPC_noRun);
r_STIMxPOST_noRun = T.rCorr1D_stmXpost(tPC_noRun);
...
r_PRExPRE_noRw = T.rCorr1D_preXpre(tPC_noRw);
r_PRExSTIM_noRw = T.rCorr1D_preXstm(tPC_noRw);
r_PRExPOST_noRw = T.rCorr1D_preXpost(tPC_noRw);
r_STIMxPOST_noRw = T.rCorr1D_stmXpost(tPC_noRw);
...
print('-painters','-r300','-dtiff',['f_CellReports_SpatialCorr_8Hz_',datestr(now,formatOut),'.tif']);
