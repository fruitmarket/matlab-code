...
hPlot(2) = axes('Position',axpt(nCol,nRow,1:2,2,[0.1 0.1 0.85 0.85],wideInterval));
...
print('-painters','-r300','-depsc',['f_short_supple5_InOutZone_',datestr(now,formatOut),'_13.ai']);
% close;