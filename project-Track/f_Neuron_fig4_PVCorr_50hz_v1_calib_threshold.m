...
% tPC_Run = T.taskType == 'DRun' & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField;
...
% tPC_Run = T.taskType == 'inRun' & T.idxNeurontype == 'PN' & T.idxPeakFR;
...
outlightZone_PRE_Run = tPC_outRun_PRE(:,ctrl_calib_run(1):ctrl_calib_run(2));
outlightZone_STM_Run = tPC_outRun_STM(:,ctrl_calib_run(1):ctrl_calib_run(2));
outlightZone_POST_Run = tPC_outRun_POST(:,ctrl_calib_run(1):ctrl_calib_run(2));
...
% tPC_Rw = T.taskType == 'DRw' & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField;
...
outlightZone_PRE_Rw = tPC_outRw_PRE(:,ctrl_calib_rw(1):ctrl_calib_rw(2));
outlightZone_STM_Rw = tPC_outRw_STM(:,ctrl_calib_rw(1):ctrl_calib_rw(2));
outlightZone_POST_Rw = tPC_outRw_POST(:,ctrl_calib_rw(1):ctrl_calib_rw(2));
...
innoRun_PRE = innoRun_PRE(:,lightLoc_Run(1):lightLoc_Run(2));
innoRun_STM = innoRun_STM(:,lightLoc_Run(1):lightLoc_Run(2));
innoRun_POST = innoRun_POST(:,lightLoc_Run(1):lightLoc_Run(2));
...
innoRw_PRE = innoRw_PRE(:,lightLoc_Rw(1):lightLoc_Rw(2));
innoRw_STM = innoRw_STM(:,lightLoc_Rw(1):lightLoc_Rw(2));
innoRw_POST = innoRw_POST(:,lightLoc_Rw(1):lightLoc_Rw(2));
...
%% statistic
group_Run = [ones(nBin_inlightRun,1);2*ones(nBin_outlightRun,1);3*ones(nBin_ctrlrun,1)];
group_Rw = [ones(nBin_inlightRw,1);2*ones(nBin_outlightRw,1);3*ones(nBin_ctrlrw,1)];
...
% Run session
[p_totalRun(1), table, stats] = kruskalwallis([pvCorr_inRun_preXstm,pvCorr_outRun_preXstm,pvCorr_innoRun_preXstm],group_Run,'off');
...
[p_totalRun(2), table, stats] = kruskalwallis([pvCorr_inRun_preXpost,pvCorr_outRun_preXpost,pvCorr_innoRun_preXpost],group_Run,'off');
% result_Run = multcompare(stats,'ctype','hsd','Display','off');
% result_Run = multcompare(stats,'ctype','bonferroni','Display','off');
result_Run = multcompare(stats,'ctype','lsd','Display','off');
p_Run(:,2) = result_Run(:,end);

[p_totalRun(3), table, stats] = kruskalwallis([pvCorr_inRun_stmXpost,pvCorr_outRun_stmXpost,pvCorr_innoRun_stmXpost],group_Run,'off');
% result_Run = multcompare(stats,'ctype','hsd','Display','off');
% result_Run = multcompare(stats,'ctype','bonferroni','Display','off');
result_Run = multcompare(stats,'ctype','lsd','Display','off');
...
% Rw session
[p_totalRw(1), table, stats] = kruskalwallis([pvCorr_inRw_preXstm,pvCorr_outRw_preXstm,pvCorr_innoRw_preXstm],group_Rw,'off');
...
[p_totalRw(2), table, stats] = kruskalwallis([pvCorr_inRw_preXpost,pvCorr_outRw_preXpost,pvCorr_innoRw_preXpost],group_Rw,'off');
% result_Rw = multcompare(stats,'ctype','hsd','Display','off');
% result_Rw = multcompare(stats,'ctype','bonferroni','Display','off');
result_Rw = multcompare(stats,'ctype','lsd','Display','off');
p_Rw(:,2) = result_Rw(:,end);

[p_totalRw(3), table, stats] = kruskalwallis([pvCorr_inRw_stmXpost,pvCorr_outRw_stmXpost,pvCorr_innoRw_stmXpost],group_Rw,'off');
% result_Rw = multcompare(stats,'ctype','hsd','Display','off');
% result_Rw = multcompare(stats,'ctype','bonferroni','Display','off');
result_Rw = multcompare(stats,'ctype','lsd','Display','off');
...
xScatterTotalrun = (rand(nBin_ctrlrun,1)-0.5)*barWidth*2.2;
xScatterTotalrw = (rand(nBin_ctrlrw,1)-0.5)*barWidth*2.2;
...
hold on;
plot(3+xScatterTotalrun, pvCorr_innoRun_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(7+xScatterTotalrun, pvCorr_innoRun_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(3+xScatterTotalrw, pvCorr_innoRw_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(7+xScatterTotalrw, pvCorr_innoRw_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
% print('-painters','-r300','-dtiff',['f_Neuron_PVCorr_',datestr(now,formatOut),'_50Hz_block_bin5sd2_calib_threshold','.tif']);
