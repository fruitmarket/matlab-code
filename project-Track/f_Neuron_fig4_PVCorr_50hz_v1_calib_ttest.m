...
% Run session
[~, p_Run(1)] = ttest(pvCorr_inRun_preXstm,pvCorr_outRun_preXstm);
[~, p_Run(2)] = ttest(pvCorr_inRun_preXpost,pvCorr_outRun_preXpost);
[~, p_Run(3)] = ttest(pvCorr_inRun_stmXpost,pvCorr_outRun_stmXpost);

% Rw session
[~, p_Rw(1)] = ttest(pvCorr_inRw_preXstm,pvCorr_outRw_preXstm);
[~, p_Rw(2)] = ttest(pvCorr_inRw_preXpost,pvCorr_outRw_preXpost);
[~, p_Rw(3)] = ttest(pvCorr_inRw_stmXpost,pvCorr_outRw_stmXpost);
...
hold on;
plot(3+xScatterTotalrun, pvCorr_noRun_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(7+xScatterTotalrun, pvCorr_noRun_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(11+xScatterTotalrun, pvCorr_noRun_stmXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(3+xScatterTotalrw, pvCorr_noRw_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(7+xScatterTotalrw, pvCorr_noRw_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
hold on;
plot(11+xScatterTotalrw, pvCorr_noRw_stmXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
print('-painters','-r300','-dtiff',['f_Neuron_PVCorr_',datestr(now,formatOut),'_50Hz_block_bin5sd2_calib_ttest','.tif']);
