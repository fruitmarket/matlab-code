...
[p_totalRun(3), table, stats] = friedman([pvCorr_noRun_preXstm',pvCorr_noRun_preXpost',pvCorr_noRun_stmXpost'],1,'off');
...
[p_totalRw(3), table, stats] = friedman([pvCorr_noRw_preXstm',pvCorr_noRw_preXpost',pvCorr_noRw_stmXpost'],1,'off');
...
plot(9+xScatterTotalrun, pvCorr_noRun_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(10+xScatterTotalrun, pvCorr_noRun_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
plot(9+xScatterTotalrw, pvCorr_noRw_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(10+xScatterTotalrw, pvCorr_noRw_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
print('-painters','-r300','-dtiff',['f_Neuron_PVCorr_',datestr(now,formatOut),'_50Hz_zone_bin5sd2_calib','.tif']);
