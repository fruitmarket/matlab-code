...
%% collect examples
example_50run = tPC_50run & T50.rCorr1D_preXpost<0.5;
plot_Track_multi_v50hz(T50.path(example_50run),T50.cellID(example_50run),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\50run_PRExPOST');
% 
example_50rw = tPC_50run & T50.rCorr1D_preXpost<0.5;
plot_Track_multi_v50hz(T50.path(example_50rw),T50.cellID(example_50rw),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\50rw_PRExPOST');

example_8run = tPC_8run & T.rCorr1D_preXpost<0.5;
plot_Track_multi_v3(T.path(example_8run),T.cellID(example_8run),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\8run_PRExPOST');

example_8rw = tPC_8rw & T.rCorr1D_preXpost<0.5;
plot_Track_multi_v3(T.path(example_8rw),T.cellID(example_8rw),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\8rw_PRExPOST');

example_noRun = tPC_noRun & T.rCorr1D_preXpost<0.5;
plot_Track_multi_v3(T.path(example_noRun),T.cellID(example_noRun),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\noRun_PRExPOST');

example_noRw = tPC_noRw & T.rCorr1D_preXpost<0.5;
plot_Track_multi_v3(T.path(example_noRw),T.cellID(example_noRw),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\noRw_PRExPOST');
%%
...
% 50 Run
rMov_total_50run = cell2mat(T50.rCorrRawMov1D(tPC_50run));
rMov_in_50run = cell2mat(T50.rCorrRawMov1D_Inzone(tPC_50run));
rMov_out_50run = cell2mat(T50.rCorrRawMov1D_Outzone(tPC_50run));
...
% 50 Rw
rMov_total_50rw = cell2mat(T50.rCorrRawMov1D(tPC_50rw));
rMov_in_50rw = cell2mat(T50.rCorrRawMov1D_Inzone(tPC_50rw));
rMov_out_50rw = cell2mat(T50.rCorrRawMov1D_Outzone(tPC_50rw));
...
% 8 Run
rMov_total_8run = cell2mat(T.rCorrRawMov1D(tPC_8run));
rMov_in_8run = cell2mat(T.rCorrRawMov1D_Inzone(tPC_8run));
rMov_out_8run = cell2mat(T.rCorrRawMov1D_Outzone(tPC_8run));
...
% 8 Rw
rMov_total_8rw = cell2mat(T.rCorrRawMov1D(tPC_8rw));
rMov_in_8rw = cell2mat(T.rCorrRawMov1D_Inzone(tPC_8rw));
rMov_out_8rw = cell2mat(T.rCorrRawMov1D_Outzone(tPC_8rw));
...
% 8 noRun
rMov_total_noRun = cell2mat(T.rCorrRawMov1D(tPC_noRun));
rMov_in_noRun = cell2mat(T.rCorrRawMov1D_Inzone(tPC_noRun));
rMov_out_noRun = cell2mat(T.rCorrRawMov1D_Outzone(tPC_noRun));
...
% 8 noRw
rMov_total_noRw = cell2mat(T.rCorrRawMov1D(tPC_noRw));
rMov_in_noRw = cell2mat(T.rCorrRawMov1D_Inzone(tPC_noRw));
rMov_out_noRw = cell2mat(T.rCorrRawMov1D_Outzone(tPC_noRw));
...
% print('-painters','-r300','-dtiff',['f_Neuron_SPCorr_smoothed_',datestr(now,formatOut),'_raw','.tif']);
