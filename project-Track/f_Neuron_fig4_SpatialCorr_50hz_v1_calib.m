...
noRun_PRE = noRun_PRE(:,lightLoc_Run(1):lightLoc_Run(2));
noRun_STM = noRun_STM(:,lightLoc_Run(1):lightLoc_Run(2));
noRun_POST = noRun_POST(:,lightLoc_Run(1):lightLoc_Run(2));
...
noRw_PRE = noRw_PRE(:,lightLoc_Rw(1):lightLoc_Rw(2));
noRw_STM = noRw_STM(:,lightLoc_Rw(1):lightLoc_Rw(2));
noRw_POST = noRw_POST(:,lightLoc_Rw(1):lightLoc_Rw(2));
...
% print('-painters','-r300','-dtiff',['f_Neuron_SpatialCorr_',datestr(now,formatOut),'_50Hz_block_bin5sd2_calib_1','.tif']);
