...
lightLoc_Run = [1:124];
lightLoc_RunCtrl = [1:124];
lightLoc_Rw = [1:124];
lightLoc_RwCtrl = [1:124];
% 2cm win
...
noRun_PRE = noRun_PRE(:,lightLoc_Run);
noRun_STM = noRun_STM(:,lightLoc_Run);
noRun_POST = noRun_POST(:,lightLoc_Run);
...
% lowExample = tPC_noRun & T.rCorr1D_preXpre<0;

% a = T.path(tPC_noRun);
% b = T.cellID(tPC_noRun);
% c = rCorr_noRun_preXpost<0;
% plot_Track_multi_v3(a(c),b(c),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\noRun_lowRcor')
...
bar([1,4,7],m_rCorr_inlight_Run,barWidth,'faceColor',colorLLightBlue);
hold on;
errorbarJun([1,4,7],m_rCorr_inlight_Run,sem_rCorr_inlight_Run,0.3,1.0,colorBlack);
hold on;
bar([2,5,8],m_rCorr_noRun,barWidth,'faceColor',colorDarkGray)
hold on;
errorbarJun([2,5,8],m_rCorr_noRun,sem_rCorr_noRun,0.3,1.0,colorBlack);
hold on;

plot(1+xScatterRunIn, rCorr_inRun_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(2+xScatterNoRun, rCorr_noRun_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;

plot(4+xScatterRunIn, rCorr_inRun_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(5+xScatterNoRun, rCorr_noRun_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;

plot(7+xScatterRunIn, rCorr_inRun_stmXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(8+xScatterNoRun, rCorr_noRun_stmXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
text(0.5, -2.1,['p11 = ',num2str(p_Run(2,1),3)],'fontSize',fontM,'color',colorBlack);
...
text(4.5, -2.1,[num2str(p_Run(2,2),3)],'fontSize',fontM,'color',colorBlack);
...
text(7.5, -2.1,[num2str(p_Run(2,3),3)],'fontSize',fontM,'color',colorBlack);
...
bar([1,4,7],m_rCorr_inlight_Rw,barWidth,'faceColor',colorLLightBlue);
hold on;
errorbarJun([1,4,7],m_rCorr_inlight_Rw,sem_rCorr_inlight_Rw,0.3,1.0,colorBlack);
hold on;
bar([2,5,8],m_rCorr_noRw,barWidth,'faceColor',colorDarkGray)
hold on;
errorbarJun([2,5,8],m_rCorr_noRw,sem_rCorr_noRw,0.3,1.0,colorBlack);
hold on;

plot(1+xScatterRwIn, rCorr_inRw_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(2+xScatterNoRw, rCorr_noRw_preXstm, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;

plot(4+xScatterRwIn, rCorr_inRw_preXpost,'.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(5+xScatterNoRw, rCorr_noRw_preXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;

plot(7+xScatterRwIn, rCorr_inRw_stmXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
plot(8+xScatterNoRw, rCorr_noRw_stmXpost, '.','markerSize',dotS,'markerFaceColor',colorWhite,'markerEdgeColor',colorGray);
hold on;
...
text(0.5, -2.1,['p12 = ',num2str(p_Rw(2,1),3)],'fontSize',fontM,'color',colorBlack);
...
text(4.5, -2.1,[num2str(p_Rw(2,2),3)],'fontSize',fontM,'color',colorBlack);
...
text(7.5, -2.1,[num2str(p_Rw(2,3),3)],'fontSize',fontM,'color',colorBlack);
% text(9.5, -2.3,[num2str(p_Rw(3,3),3)],'fontSize',fontM,'color',colorBlack);

set(hPVCorr(1),'TickDir','out','Box','off','XLim',[0,9],'YLim',[-1.15 1.15],'XTick',[1.5, 4.5, 7.5],'XTickLabel',[{'PRExSTIM','PRExPOST','STIMxPOST'}],'fontSize',fontM);
set(hPVCorr(2),'TickDir','out','Box','off','XLim',[0,9],'YLim',[-1.15 1.15],'XTick',[1.5, 4.5, 7.5],'XTickLabel',[{'PRExSTIM','PRExPOST','STIMxPOST'}],'fontSize',fontM);
set(hPVCorr,'TickLength',[0.03, 0.03]);

print('-painters','-r300','-dtiff',['f_Neuron_SpatialCorr_',datestr(now,formatOut),'_8Hz_block_total_1','.tif']);
