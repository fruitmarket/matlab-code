...
% Run session
[~, p_Run(1)] = ttest2(rCorr_inRun_preXstm(~isnan(rCorr_inRun_preXstm)), rCorr_outRun_preXstm(~isnan(rCorr_outRun_preXstm)));
[~, p_Run(2)] = ttest2(rCorr_inRun_preXpost(~isnan(rCorr_inRun_preXpost)), rCorr_outRun_preXpost(~isnan(rCorr_outRun_preXpost)));
[~, p_Run(3)] = ttest2(rCorr_inRun_stmXpost(~isnan(rCorr_inRun_stmXpost)), rCorr_outRun_stmXpost(~isnan(rCorr_outRun_stmXpost)));

% Rw session
[~, p_Rw(1)] = ttest2(rCorr_inRw_preXstm(~isnan(rCorr_inRw_preXstm)), rCorr_outRw_preXstm(~isnan(rCorr_outRw_preXstm)));
[~, p_Rw(2)] = ttest2(rCorr_inRw_preXpost(~isnan(rCorr_inRw_preXpost)), rCorr_outRw_preXpost(~isnan(rCorr_outRw_preXpost)));
[~, p_Rw(3)] = ttest2(rCorr_inRw_stmXpost(~isnan(rCorr_inRw_stmXpost)), rCorr_outRw_stmXpost(~isnan(rCorr_outRw_stmXpost)));
...
print('-painters','-r300','-dtiff',['f_Neuron_SpatialCorr_',datestr(now,formatOut),'_50Hz_block_bin5sd2_calib_ttest','.tif']);
