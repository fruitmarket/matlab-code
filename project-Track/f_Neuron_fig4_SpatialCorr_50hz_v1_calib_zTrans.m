...
rCorr_inRun_preXstm = fisherZ(rCorr_inRun_preXstm);
rCorr_inRun_preXpost = fisherZ(rCorr_inRun_preXpost);
rCorr_inRun_stmXpost = fisherZ(rCorr_inRun_stmXpost);
rCorr_outRun_preXstm = fisherZ(rCorr_outRun_preXstm);
rCorr_outRun_preXpost = fisherZ(rCorr_outRun_preXpost);
rCorr_outRun_stmXpost = fisherZ(rCorr_outRun_stmXpost);
...
rCorr_inRw_preXstm = fisherZ(rCorr_inRw_preXstm);
rCorr_inRw_preXpost = fisherZ(rCorr_inRw_preXpost);
rCorr_inRw_stmXpost = fisherZ(rCorr_inRw_stmXpost);
rCorr_outRw_preXstm = fisherZ(rCorr_outRw_preXstm);
rCorr_outRw_preXpost = fisherZ(rCorr_outRw_preXpost);
rCorr_outRw_stmXpost = fisherZ(rCorr_outRw_stmXpost);
...
rCorr_noRun_preXstm = fisherZ(rCorr_noRun_preXstm);
rCorr_noRun_preXpost = fisherZ(rCorr_noRun_preXpost);
rCorr_noRun_stmXpost = fisherZ(rCorr_noRun_stmXpost);
...
% plot_Track_multi_v3(T.path(lowExample),T.cellID(lowExample),'D:\Dropbox\SNL\P2_Track\example_lowSpatialCorr\noRun_check')
...
rCorr_noRw_preXstm = fisherZ(rCorr_noRw_preXstm);
rCorr_noRw_preXpost = fisherZ(rCorr_noRw_preXpost);
rCorr_noRw_stmXpost = fisherZ(rCorr_noRw_stmXpost);
...
[p_totalRw(2), table, stats] = anova1([rCorr_inRw_preXpost(~isnan(rCorr_inRw_preXpost)); rCorr_outRw_preXpost(~isnan(rCorr_outRw_preXpost)); rCorr_noRw_preXpost(~isnan(rCorr_noRw_preXpost))],[ones(sum(double(~isnan(rCorr_inRw_preXpost))),1); 2*ones(sum(double(~isnan(rCorr_outRw_preXpost))),1); 3*ones(sum(double(~isnan(rCorr_noRw_preXpost))),1)],'off');
result_Rw = multcompare(stats,'ctype','hsd','Display','off');
% result_Rw = multcompare(stats,'ctype','bonferroni','Display','off');
% result_Rw = multcompare(stats,'ctype','lsd','Display','off');
p_Rw(:,2) = result_Rw(:,end);

[p_totalRw(3), table, stats] = anova1([rCorr_inRw_stmXpost(~isnan(rCorr_inRw_stmXpost)); rCorr_outRw_stmXpost(~isnan(rCorr_outRw_stmXpost)); rCorr_noRw_stmXpost(~isnan(rCorr_noRw_stmXpost))],[ones(sum(double(~isnan(rCorr_inRw_stmXpost))),1); 2*ones(sum(double(~isnan(rCorr_outRw_stmXpost))),1); 3*ones(sum(double(~isnan(rCorr_noRw_stmXpost))),1)],'off');
result_Rw = multcompare(stats,'ctype','hsd','Display','off');
% result_Rw = multcompare(stats,'ctype','bonferroni','Display','off');
% result_Rw = multcompare(stats,'ctype','lsd','Display','off');
...
set(hPVCorr(1),'TickDir','out','Box','off','XLim',[0,12],'YLim',[-2 2],'XTick',[2, 6, 10],'XTickLabel',[{'PRExSTIM','PRExPOST','STIMxPOST'}],'fontSize',fontM);
set(hPVCorr(2),'TickDir','out','Box','off','XLim',[0,12],'YLim',[-2 2],'XTick',[2, 6, 10],'XTickLabel',[{'PRExSTIM','PRExPOST','STIMxPOST'}],'fontSize',fontM);
set(hPVCorr,'TickLength',[0.03, 0.03]);

% print('-painters','-r300','-dtiff',['f_Neuron_SpatialCorr_',datestr(now,formatOut),'_8Hz_block_bin5sd2_calib_zTrans','.tif']);
print('-painters','-r300','-dtiff',['f_Neuron_SpatialCorr_',datestr(now,formatOut),'_50Hz_block_bin5sd2_calib_zTrans','.tif']);
