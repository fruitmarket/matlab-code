...
% light
l_PF_inField_act = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOutPRE & T.idxmFrIn == 1));
l_PF_inField_ina = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOutPRE & T.idxmFrIn == -1));
l_PF_inField_no = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOutPRE & T.idxmFrIn == 0));
% nolight
...
% control
% con_PF_inField_act = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & Tcon.idxZoneInOutSTM & Tcon.idxmFrIn == 1));
% con_PF_inField_ina = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & Tcon.idxZoneInOutSTM & Tcon.idxmFrIn == -1));
% con_PF_inField_no = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & Tcon.idxZoneInOutSTM & Tcon.idxmFrIn == 0));

l_PF_outField_act = sum(double(T.taskType == 'DRun' & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOutPRE & T.idxmFrIn == 1));
l_PF_outField_ina = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOutPRE & T.idxmFrIn == -1));
l_PF_outField_no = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOutPRE & T.idxmFrIn == 0));
...
% con_PF_outField_act = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & ~Tcon.idxZoneInOutSTM & Tcon.idxmFrOut == 1));
% con_PF_outField_ina = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & ~Tcon.idxZoneInOutSTM & Tcon.idxmFrOut == -1));
% con_PF_outField_no = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & ~Tcon.idxZoneInOutSTM & Tcon.idxmFrOut == 0));

l_NPF_act = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxmFrIn == 1));
l_NPF_ina = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxmFrIn == -1));
l_NPF_no = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxmFrIn == 0));
...
% con_NPF_act = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & ~(Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum) & Tcon.idxmFrTotal == 1));
% con_NPF_ina = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & ~(Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum) & Tcon.idxmFrTotal == -1));
% con_NPF_no = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & ~(Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum) & Tcon.idxmFrTotal == 0));
...
%%
l_PN_act = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxmFrTotal == 1));
l_PN_ina = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxmFrTotal == -1));
l_PN_no = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxmFrTotal == 0));
...
% con_PN_act = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxmFrTotal == 1));
% con_PN_ina = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxmFrTotal == -1));
% con_PN_no = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'PN' & Tcon.idxmFrTotal == 0));
...
l_IN_act = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'IN' & T.idxmFrTotal == 1));
l_IN_ina = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'IN' & T.idxmFrTotal == -1));
l_IN_no = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'IN' & T.idxmFrTotal == 0));
...
% con_IN_act = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'IN' & Tcon.idxmFrTotal == 1));
% con_IN_ina = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'IN' & Tcon.idxmFrTotal == -1));
% con_IN_no = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'IN' & Tcon.idxmFrTotal == 0));
...
l_UNC_act = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'UNC' & T.idxmFrTotal == 1));
l_UNC_ina = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'UNC' & T.idxmFrTotal == -1));
l_UNC_no = sum(double((T.taskType == 'DRun') & T.idxNeurontype == 'UNC' & T.idxmFrTotal == 0));
...
% con_UNC_act = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'UNC' & Tcon.idxmFrTotal == 1));
% con_UNC_ina = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'UNC' & Tcon.idxmFrTotal == -1));
% con_UNC_no = sum(double((Tcon.taskType == 'DRun') & Tcon.idxNeurontype == 'UNC' & Tcon.idxmFrTotal == 0));
...
%% examples
a = (T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOutPRE & T.idxmFrIn == 1;
b = (T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOutPRE & T.idxmFrIn == -1;
c = (T.taskType == 'DRun') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOutPRE & T.idxmFrIn == 0;

d = T.taskType == 'DRun' & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOutPRE & T.idxmFrIn == 1;
e = T.taskType == 'DRun' & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOutPRE & T.idxmFrIn == -1;
f = T.taskType == 'DRun' & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOutPRE & T.idxmFrIn == 0;

% g = (T.taskType == 'DRun') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxmFrTotal == 1;
% h = (T.taskType == 'DRun') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxmFrTotal == -1;
% i = (T.taskType == 'DRun') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxmFrTotal == 0;
...
print('-painters','-depsc','-r300',['final_fig6_InOutRun_',datestr(now,formatOut),'.ai']);
