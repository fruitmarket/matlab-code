...
% Pyramidal neuron
actPN_peth10 = cell2mat(T.peth10ms(listPN & T.statDir_Plfm2hz ==1 & Txls.latencyIndex == 'indirect'));
actPN_peth50 = cell2mat(T.peth50ms(listPN & T.statDir_Plfm2hz ==1 & Txls.latencyIndex == 'indirect'));
...
print('-painters','-r300','-dtiff',['final_fig2_platform_laserWidth_indirect_',datestr(now,formatOut),'.tif']);
