function f_fig2_platform_freq_example_buildup
...
cd(saveDir);
print('-painters','-r300','-dtiff',['final_fig2_platform_freq_example2_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['final_fig2_platform_freq_example2_',datestr(now,formatOut),'.ai']);
close;
