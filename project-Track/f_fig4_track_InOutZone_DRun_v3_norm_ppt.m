...
hPlot(1) = axes('Position',axpt(2,1,1,1,[0.1 0.1 0.85 0.85],wideInterval));
...
hPlot(2) = axes('Position',axpt(2,1,2,1,[0.1 0.1 0.85 0.85],wideInterval));
bar(xBar,m_frInZone,'BarWidth',0.6,'LineStyle','-','edgeColor',colorBlack,'FaceColor',colorDarkGray,'lineWidth',1);
hold on;
line([0 6],[1, 1],'lineStyle',':','color',colorRed);
hold on;
...
print('-painters','-r300','-dtiff',['final_figXX_InOutZone_DRun_v2_norm_ppt_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['final_figXX_InOutZone_DRun_v2_norm_ppt_',datestr(now,formatOut),'.ai']);
close;