...
print('-painters','-r300','-dtiff',['final_figXX_InOutZone_DRun_v2_norm_thesis_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['final_figXX_InOutZone_DRun_v2_norm_thesis_',datestr(now,formatOut),'.ai']);
close;