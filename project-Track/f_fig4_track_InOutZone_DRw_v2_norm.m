...
% DRwPN = T.taskType == 'DRw' & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum; % place cell
DRwPN = T.taskType == 'DRw' & T.idxNeurontype == 'PN'; % all recorded pyramidal neuron
...
group = {'PRE','STM','POST'};
[p_kw50hzIn,tbl_p_kw50hzIn,stats] = kruskalwallis([fr_Inzone(:,1),fr_Inzone(:,2),fr_Inzone(:,3)],group,'off');
...
text(2,yLim(3)*0.75,['p = ',num2str(round(p_ttest(3)*1000)/1000)],'fontSize',fontS);
...
set(hPlot(1),'YLim',[0,yLim(1)],'YTick',[0:10]);
% set(hPlot(2),'YLim',[0,yLim(2)],'YTick',[0:10]);
set(hPlot(2),'YLim',[0,yLim(3)],'YTick',[0:4]);
% set(hPlot(4),'YLim',[0,yLim(4)],'YTick',[0:4]);
