...
print('-painters','-r300','-dtiff',['final_figXX_InOutZone_DRw_v2_norm_jn_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['final_figXX_InOutZone_DRw_v2_norm_jn_',datestr(now,formatOut),'.ai']);
close;