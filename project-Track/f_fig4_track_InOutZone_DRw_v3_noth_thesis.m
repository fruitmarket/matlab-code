...
fr_Inzone_act = [m_lapFrInPRE(DRwPN  & idx_inc & idx_pPRExSTM), m_lapFrInSTM(DRwPN  & idx_inc & idx_pPRExSTM), m_lapFrInPOST(DRwPN  & idx_inc & idx_pPRExSTM)]; 
fr_Inzone_ina = [m_lapFrInPRE(DRwPN  & idx_dec & idx_pPRExSTM), m_lapFrInSTM(DRwPN  & idx_dec & idx_pPRExSTM), m_lapFrInPOST(DRwPN  & idx_dec & idx_pPRExSTM)];
fr_Inzone_no = [m_lapFrInPRE(DRwPN  & ~idx_pPRExSTM), m_lapFrInSTM(DRwPN  & ~idx_pPRExSTM), m_lapFrInPOST(DRwPN  & ~idx_pPRExSTM)];
...
fr_Outzone_act = [m_lapFrOutPRE(DRwPN  & idx_inc & idx_pPRExSTM), m_lapFrOutSTM(DRwPN  & idx_inc & idx_pPRExSTM), m_lapFrOutPOST(DRwPN  & idx_inc & idx_pPRExSTM)]; 
fr_Outzone_ina = [m_lapFrOutPRE(DRwPN  & idx_dec & idx_pPRExSTM), m_lapFrOutSTM(DRwPN  & idx_dec & idx_pPRExSTM), m_lapFrOutPOST(DRwPN  & idx_dec & idx_pPRExSTM)];
fr_Outzone_no = [m_lapFrOutPRE(DRwPN  & ~idx_pPRExSTM), m_lapFrOutSTM(DRwPN  & ~idx_pPRExSTM), m_lapFrOutPOST(DRwPN  & ~idx_pPRExSTM)];
...
print('-painters','-r300','-dtiff',['final_figXX_InOutZone_DRw_v2_noth_thesis_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['final_figXX_InOutZone_DRw_v2_noth_thesis_',datestr(now,formatOut),'.ai']);
close;