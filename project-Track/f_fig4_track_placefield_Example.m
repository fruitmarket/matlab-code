...
% cellID = [557 792 176 731 134 674]; % for DRun sessions 170928 (inAct, inIn, inNo / outAct, outIn, outNo)
cellID = [551 24 858 947 879 298]; % for DRw sessions 170928 (inAct, inIn, inNo / outAct, outIn, outNo)
nCell = length(cellID);
...
%         uistack(rec,'bottom');
    ...
    set(hPlot(1),'Box','off','TickDir','out','fontSize',fontS,'XLim',[-100 1000],'XTick',[-100,0,500,1000],'YLim',[0,90],'YTick',[0:30:90]);
