...
l_PF_inField_act = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOut & T.idxSpikeIn == 1));
l_PF_inField_ina = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOut & T.idxSpikeIn == -1));
l_PF_inField_no = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOut & T.idxSpikeIn == 0));
nol_PF_inField_act = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOut & T.idxSpikeIn == 1));
nol_PF_inField_ina = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOut & T.idxSpikeIn == -1));
nol_PF_inField_no = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & T.idxZoneInOut & T.idxSpikeIn == 0));
con_PF_inField_act = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & Tcon.idxZoneInOut & Tcon.idxSpikeIn == 1));
con_PF_inField_ina = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & Tcon.idxZoneInOut & Tcon.idxSpikeIn == -1));
con_PF_inField_no = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & Tcon.idxZoneInOut & Tcon.idxSpikeIn == 0));
...
l_PF_outField_act = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeOut == 1));
l_PF_outField_ina = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeOut == -1));
l_PF_outField_no = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeOut == 0));
nol_PF_outField_act = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeOut == 1));
nol_PF_outField_ina = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeOut == -1));
nol_PF_outField_no = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum & ~T.idxZoneInOut & T.idxSpikeOut == 0));
con_PF_outField_act = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & ~Tcon.idxZoneInOut & Tcon.idxSpikeOut == 1));
con_PF_outField_ina = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & ~Tcon.idxZoneInOut & Tcon.idxSpikeOut == -1));
con_PF_outField_no = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum & ~Tcon.idxZoneInOut & Tcon.idxSpikeOut == 0));
...
l_NPF_act = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxSpikeTotal == 1));
l_NPF_ina = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxSpikeTotal == -1));
l_NPF_no = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxSpikeTotal == 0));
nol_NPF_act = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxSpikeTotal == 1));
nol_NPF_ina = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxSpikeTotal == -1));
nol_NPF_no = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & ~(T.idxPeakFR & T.idxPlaceField & T.idxTotalSpikeNum) & T.idxSpikeTotal == 0));
con_NPF_act = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & ~(Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum) & Tcon.idxSpikeTotal == 1));
con_NPF_ina = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & ~(Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum) & Tcon.idxSpikeTotal == -1));
con_NPF_no = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & ~(Tcon.idxPeakFR & Tcon.idxPlaceField & Tcon.idxTotalSpikeNum) & Tcon.idxSpikeTotal == 0));
...
l_PN_act = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxSpikeTotal == 1));
l_PN_ina = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxSpikeTotal == -1));
l_PN_no = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'PN' & T.idxSpikeTotal == 0));
nol_PN_act = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxSpikeTotal == 1));
nol_PN_ina = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxSpikeTotal == -1));
nol_PN_no = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'PN' & T.idxSpikeTotal == 0));
con_PN_act = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxSpikeTotal == 1));
con_PN_ina = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxSpikeTotal == -1));
con_PN_no = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'PN' & Tcon.idxSpikeTotal == 0));
...
l_IN_act = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'IN' & T.idxSpikeTotal == 1));
l_IN_ina = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'IN' & T.idxSpikeTotal == -1));
l_IN_no = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'IN' & T.idxSpikeTotal == 0));
nol_IN_act = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'IN' & T.idxSpikeTotal == 1));
nol_IN_ina = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'IN' & T.idxSpikeTotal == -1));
nol_IN_no = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'IN' & T.idxSpikeTotal == 0));
con_IN_act = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'IN' & Tcon.idxSpikeTotal == 1));
con_IN_ina = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'IN' & Tcon.idxSpikeTotal == -1));
con_IN_no = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'IN' & Tcon.idxSpikeTotal == 0));
...
l_UNC_act = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'UNC' & T.idxSpikeTotal == 1));
l_UNC_ina = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'UNC' & T.idxSpikeTotal == -1));
l_UNC_no = sum(double((T.taskType == 'DRw') & T.idxNeurontype == 'UNC' & T.idxSpikeTotal == 0));
nol_UNC_act = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'UNC' & T.idxSpikeTotal == 1));
nol_UNC_ina = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'UNC' & T.idxSpikeTotal == -1));
nol_UNC_no = sum(double((T.taskType == 'noRw') & T.idxNeurontype == 'UNC' & T.idxSpikeTotal == 0));
con_UNC_act = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'UNC' & Tcon.idxSpikeTotal == 1));
con_UNC_ina = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'UNC' & Tcon.idxSpikeTotal == -1));
con_UNC_no = sum(double((Tcon.taskType == 'DRw') & Tcon.idxNeurontype == 'UNC' & Tcon.idxSpikeTotal == 0));
