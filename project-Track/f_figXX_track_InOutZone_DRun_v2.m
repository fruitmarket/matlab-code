...
fr_Inzone = [m_lapFrInPRE(DRunPN & idx_Fr), m_lapFrInSTM(DRunPN & idx_Fr), m_lapFrInPOST(DRunPN & idx_Fr)];
...
fr_Outzone = [m_lapFrOutPRE(DRunPN & idx_Fr), m_lapFrOutSTM(DRunPN & idx_Fr), m_lapFrOutPOST(DRunPN & idx_Fr)];
...
print('-painters','-r300','-dtiff',['final_figXX_InOutZone_DRun_v2_nonorm_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['final_figXX_InOutZone_DRun_v2_nonorm_',datestr(now,formatOut),'.ai']);
close;