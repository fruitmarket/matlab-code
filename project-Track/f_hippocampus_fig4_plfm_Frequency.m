...
%% supple spike number
% nSpk1hz = sum(double(0<xpt1hz_ori{1} & xpt1hz_ori{1}<15));
% nSpk2hz = sum(double(0<xpt2hz_ori{1} & xpt2hz_ori{1}<15));
% nSpk8hz = sum(double(0<xpt8hz_ori{1} & xpt8hz_ori{1}<15));
% nSpk20hz = sum(double(0<xpt20hz_ori{1} & xpt20hz_ori{1}<15));
% nSpk50hz = sum(double(0<xpt50hz_ori{1} & xpt50hz_ori{1}<15));
% 
% spkTrial(:,1) = histc(ypt1hz_ori{1}(0<xpt1hz_ori{1} & xpt1hz_ori{1}<15),[1:300])';
% spkTrial(:,2) = histc(ypt2hz_ori{1}(0<xpt2hz_ori{1} & xpt2hz_ori{1}<15),[1:300])';
% spkTrial(:,3) = histc(ypt8hz_ori{1}(0<xpt8hz_ori{1} & xpt8hz_ori{1}<15),[1:300])';
% spkTrial(:,4) = histc(ypt20hz_ori{1}(0<xpt20hz_ori{1} & xpt20hz_ori{1}<15),[1:300])';
% spkTrial(:,5) = histc(ypt50hz_ori{1}(0<xpt50hz_ori{1} & xpt50hz_ori{1}<15),[1:300])';
% 
% kruskalwallis(spkTrial)
%% freq dependency
...
print('-painters','-r300','-depsc',['f_plosBio_fig2_platform_PN_',datestr(now,formatOut),'_v2.ai']);
close;