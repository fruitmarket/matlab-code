...
% print('-painters','-r300','-dtiff',['f_hippocampus_sup_powerLFP','.tif']);
% print('-painters','-r300','-depsc',['f_hippocampus_sup_powerLFP','.ai']);
...
% print('-painters','-r300','-dtiff',['f_hippocampus_sup_powerThetaGamma_prop','.tif']);
% print('-painters','-r300','-depsc',['f_hippocampus_sup_powerThetaGamma_prop','.ai']);
% close all;