...
% saveDir = 'E:\Dropbox\SNL\P2_Track\example_track50hz_plosBio_supple3\Run_Act';
% cellID = T.cellID(T.taskType == 'DRun' & T.idxNeurontype == 'PN' & idx_pPRExSTM & idx_dec);
% saveDir = 'E:\Dropbox\SNL\P2_Track\example_track50hz_plosBio_supple3\Run_Ina';
% cellID = T.cellID(T.taskType == 'DRun' & T.idxNeurontype == 'PN' & ~idx_pPRExSTM);
% saveDir = 'E:\Dropbox\SNL\P2_Track\example_track50hz_plosBio_supple3\Run_No';
% 
% cellID = T.cellID(T.taskType == 'DRw' & T.idxNeurontype == 'PN' & idx_pPRExSTM & idx_inc);
% saveDir = 'E:\Dropbox\SNL\P2_Track\example_track50hz_plosBio_supple3\Rw_Act';
% cellID = T.cellID(T.taskType == 'DRw' & T.idxNeurontype == 'PN' & idx_pPRExSTM & idx_dec);
% saveDir = 'E:\Dropbox\SNL\P2_Track\example_track50hz_plosBio_supple3\Rw_Ina';
% cellID = T.cellID(T.taskType == 'DRw' & T.idxNeurontype == 'PN' & ~idx_pPRExSTM);
% saveDir = 'E:\Dropbox\SNL\P2_Track\example_track50hz_plosBio_supple3\Rw_No';
...
ypt_lightT = ypt_lightT(:);
    ...
    hPlot(1) = axes('Position',axpt(13,3,1:11,1,[0.2 0.12 0.85 0.85],[0.01 0.10]));
        ...
        text(500,-40,'Time (sec)','fontSize',fontM);
    ...
    set(hPlot(1),'Box','off','TickDir','out','fontSize',fontM,'XLim',[-500 3000],'XTick',[-500, 0,1000, 2000, 3000],'XTickLabel',{-0.5 0, 1, 2, '3 (s)'},'YLim',[0,90],'YTick',[0:30:90],'YTickLabel',[]);
    set(hPlot(2),'Box','off','TickDir','out','fontSize',fontM,'XLim',[0,124],'XTick',[],'YLim',[0, 90],'YTick',[0:30:90],'YTickLabel',[]);
    set(hPlot(3),'Box','off','TickDir','out','fontSize',fontM,'XLim',[0,124],'XTick',[0:40:120],'XTickLabel',{0,40,80,'120 (cm)'},'YTick',[1.5,2.5,3.5],'YTickLabel',[]);
%     set(hPlot(1),'Box','off','TickDir','out','fontSize',fontM,'XLim',[-500 3000],'XTick',[-500, 0,1000, 2000, 3000],'XTickLabel',[],'YLim',[0,90],'YTick',[0:30:90],'YTickLabel',[]);
%     set(hPlot(2),'Box','off','TickDir','out','fontSize',fontM,'XLim',[0,124],'XTick',[],'YLim',[0, 90],'YTick',[0:30:90],'YTickLabel',[]);
%     set(hPlot(3),'Box','off','TickDir','out','fontSize',fontM,'XLim',[0,124],'XTick',[0:40:120],'XTickLabel',[],'YTick',[1.5,2.5,3.5],'YTickLabel',[]);
