...
text(0.8,7,['n = ',num2str(length(eYFPmeanMice))],'fontSize',fontM);
ylabel('ChETA+ granule cells (%) ','fontSize',fontM);

set(hArea,'Box','off','TickDir','out','fontSize',fontM,'XLim',[0,1.2],'XTick',[],'YLim',[0,8],'YTick',0:1:10);
