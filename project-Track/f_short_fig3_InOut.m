...
% [pRun, tbl_p_fd50hz, stats] = friedman(fr_Inzone,1);
% result = multcompare(stats,'Alpha',0.05,'Display','off');
...
set(hPlot(1),'YLim',[0,3],'YTick',[0:3]);
set(hPlot(2),'YLim',[0,3],'YTick',[0:3]);
