...
% sem_pvCorr_outlight_Rw = [nanstd(pvCorr_outRw_preXstm,0,2)/sqrt(26), nanstd(pvCorr_outRw_preXpost)/sqrt(26), nanstd(pvCorr_outRw_stmXpost)/sqrt(26)];
...
% sem_pvCorr_noRun = [std(pvCorr_noRun_preXstm,0,2)/sqrt(31), std(pvCorr_noRun_preXpost,0,2)/sqrt(31), std(pvCorr_noRun_stmXpost,0,2)/sqrt(31)];
...
% text(-2, -0.3,['p12 = ',num2str(p_kw_Run(1,1))],'fontSize',fontM,'color',colorBlack);
% text(-2, -0.5,['p13 = ',num2str(p_kw_Run(2,1))],'fontSize',fontM,'color',colorBlack);
% text(-2, -0.7,['p23 = ',num2str(p_kw_Run(3,1))],'fontSize',fontM,'color',colorBlack);
% 
% text(5.5, -0.3,[num2str(p_kw_Run(1,2))],'fontSize',fontM,'color',colorBlack);
% text(5.5, -0.5,[num2str(p_kw_Run(2,2))],'fontSize',fontM,'color',colorBlack);
% text(5.5, -0.7,[num2str(p_kw_Run(3,2))],'fontSize',fontM,'color',colorBlack);
% 
% text(11, -0.3,[num2str(p_kw_Run(1,3))],'fontSize',fontM,'color',colorBlack);
% text(11, -0.5,[num2str(p_kw_Run(2,3))],'fontSize',fontM,'color',colorBlack);
% text(11, -0.7,[num2str(p_kw_Run(3,3))],'fontSize',fontM,'color',colorBlack);
...
ylabel('PV correlation','fontSize',fontM);
% text(10, 1.2,['n (Run) = ',num2str(ntPC_DRun)],'fontSize',fontM,'color',colorDarkGray);
% text(-2, -0.3,['p12 = ',num2str(p_kw_Rw(1,1))],'fontSize',fontM,'color',colorBlack);
% text(-2, -0.5,['p13 = ',num2str(p_kw_Rw(2,1))],'fontSize',fontM,'color',colorBlack);
% text(-2, -0.7,['p23 = ',num2str(p_kw_Rw(3,1))],'fontSize',fontM,'color',colorBlack);
% 
% text(5.5, -0.3,[num2str(p_kw_Rw(1,2))],'fontSize',fontM,'color',colorBlack);
% text(5.5, -0.5,[num2str(p_kw_Rw(2,2))],'fontSize',fontM,'color',colorBlack);
% text(5.5, -0.7,[num2str(p_kw_Rw(3,2))],'fontSize',fontM,'color',colorBlack);
% 
% text(11, -0.3,[num2str(p_kw_Rw(1,3))],'fontSize',fontM,'color',colorBlack);
% text(11, -0.5,[num2str(p_kw_Rw(2,3))],'fontSize',fontM,'color',colorBlack);
% text(11, -0.7,[num2str(p_kw_Rw(3,3))],'fontSize',fontM,'color',colorBlack);
...
print('-painters','-r300','-dtiff',['f_short_suppleXX_PVCorr_InOutTotalZone_',datestr(now,formatOut),'_1cm1HzNormZ.tif']);
print('-painters','-r300','-depsc',['f_short_suppleXX_PVCorr_InOutTotalZone_',datestr(now,formatOut),'_1cm1HzNormZ.ai']);
close;