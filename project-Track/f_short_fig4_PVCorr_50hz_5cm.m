...
% TN: track neuron
tPC_DRun = T50.taskType == 'DRun' & T50.idxNeurontype == 'PN';
ntPC_DRun = sum(double(tPC_DRun));

% corr of total neurons
tPC_DRun_PRE = cell2mat(T50.rateMap1D_PRE(tPC_DRun));
tPC_DRun_STM = cell2mat(T50.rateMap1D_STM(tPC_DRun));
tPC_DRun_POST = cell2mat(T50.rateMap1D_POST(tPC_DRun));
...
%%
tPC_DRw = T50.taskType == 'DRw' & T50.idxNeurontype == 'PN';
ntPC_DRw = sum(double(tPC_DRw));

% corr of total neurons
tPC_DRw_PRE = cell2mat(T50.rateMap1D_PRE(tPC_DRw));
tPC_DRw_STM = cell2mat(T50.rateMap1D_STM(tPC_DRw));
tPC_DRw_POST = cell2mat(T50.rateMap1D_POST(tPC_DRw));
...
sem_pvCorr_outlight_Rw = [std(pvCorr_outRw_preXstm,0,2)/sqrt(112), std(pvCorr_outRw_preXpost)/sqrt(112), std(pvCorr_outRw_stmXpost)/sqrt(112)];
...
print('-painters','-r300','-dtiff',['f_short_suppleXX_PVCorr_InOutTotalZone_50hz_',datestr(now,formatOut),'_v2_5cm.tif']);
print('-painters','-r300','-depsc',['f_short_suppleXX_PVCorr_InOutTotalZone_50hz_',datestr(now,formatOut),'_v2_5cm.ai']);
close;