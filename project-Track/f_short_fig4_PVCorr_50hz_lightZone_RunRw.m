...
print('-painters','-r300','-dtiff',['f_short_suppleXX_PVCorr_RunRw_50hz_lightZone_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['f_short_suppleXX_PVCorr_RunRw_50hz_lightZone_',datestr(now,formatOut),'.ai']);
close;