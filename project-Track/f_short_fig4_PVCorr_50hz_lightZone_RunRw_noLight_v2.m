...
sem_pvCorr_noRun = [nanstd(pvCorr_noRun_preXstm,0,2)/sqrt(124), nanstd(pvCorr_noRun_preXpost,0,2)/sqrt(124), nanstd(pvCorr_noRun_stmXpost,0,2)/sqrt(124)];
...
print('-painters','-r300','-dtiff',['f_short_suppleXX_PVCorr_InOutTotalZone_',datestr(now,formatOut),'_v2.tif']);
print('-painters','-r300','-depsc',['f_short_suppleXX_PVCorr_InOutTotalZone_',datestr(now,formatOut),'_v2.ai']);
close;