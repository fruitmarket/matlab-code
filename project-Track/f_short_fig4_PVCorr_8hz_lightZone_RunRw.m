...
load('neuronList_ori_171203.mat');
...
print('-painters','-r300','-dtiff',['f_short_suppleXX_PVCorr_RunRw_8hz_lightZone_totalPN_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['f_short_suppleXX_PVCorr_RunRw_8hz_lightZone_totalPN_',datestr(now,formatOut),'.ai']);
close;