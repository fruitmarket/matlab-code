...
% result_Run = multcompare(stats,'Display','off');
...
print('-painters','-r300','-dtiff',['f_short_suppleXX_PVCorr_InOutTotalZone_8Hz_',datestr(now,formatOut),'_bonfe.tif']);
print('-painters','-r300','-depsc',['f_short_suppleXX_PVCorr_InOutTotalZone_8Hz_',datestr(now,formatOut),'_bonfe.ai']);
close;