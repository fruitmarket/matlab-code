...
inlightZone_PRE_Run = tPC_noRun_PRE(:,lightLoc_Run(1):lightLoc_Run(2));
inlightZone_STM_Run = tPC_noRun_STM(:,lightLoc_Run(1):lightLoc_Run(2));
inlightZone_POST_Run = tPC_noRun_POST(:,lightLoc_Run(1):lightLoc_Run(2));

outlightZone_PRE_Run = tPC_noRun_PRE(:,[1:lightLoc_Run(1)-1,lightLoc_Run(2)+1:124]);
outlightZone_STM_Run = tPC_noRun_STM(:,[1:lightLoc_Run(1)-1,lightLoc_Run(2)+1:124]);
outlightZone_POST_Run = tPC_noRun_POST(:,[1:lightLoc_Run(1)-1,lightLoc_Run(2)+1:124]);
...
inlightZone_PRE_Rw = tPC_noRw_PRE(:,lightLoc_Rw(1):lightLoc_Rw(2));
inlightZone_STM_Rw = tPC_noRw_STM(:,lightLoc_Rw(1):lightLoc_Rw(2));
inlightZone_POST_Rw = tPC_noRw_POST(:,lightLoc_Rw(1):lightLoc_Rw(2));

outlightZone_PRE_Rw = tPC_noRw_PRE(:,[1:lightLoc_Rw(1)-1,lightLoc_Rw(2)+1:124]);
outlightZone_STM_Rw = tPC_noRw_STM(:,[1:lightLoc_Rw(1)-1,lightLoc_Rw(2)+1:124]);
outlightZone_POST_Rw = tPC_noRw_POST(:,[1:lightLoc_Rw(1)-1,lightLoc_Rw(2)+1:124]);
...
text(4.2, 1.2,['n (noRun) = ',num2str(ntPC_noRun)],'fontSize',fontM,'color',colorDarkGray);
% text(1, -0.8,['p = ',num2str(p_Runttest_in(1))],'fontSize',fontM,'color',colorBlack);
% text(1, -1,1,['p = ',num2str(p_Runttest_in(2))],'fontSize',fontM,'color',colorBlack);
% text(1, -1.4,['p = ',num2str(p_Runttest_in(3))],'fontSize',fontM,'color',colorBlack);
...
ylabel('PV correlation','fontSize',fontM);
text(4.2, 1.2,['n (noRun) = ',num2str(ntPC_noRw)],'fontSize',fontM,'color',colorDarkGray);
...
ylabel('PV correlation','fontSize',fontM);
text(4.2, 1.2,['n (noRw) = ',num2str(ntPC_noRw)],'fontSize',fontM,'color',colorDarkGray);
text(1, -0.5,['p12 = ',num2str(p_Rwttest_in(1))],'fontSize',fontM,'color',colorBlack);
text(1, -0.7,['p13 = ',num2str(p_Rwttest_in(2))],'fontSize',fontM,'color',colorBlack);
text(1, -0.9,['p23 = ',num2str(p_Rwttest_in(3))],'fontSize',fontM,'color',colorBlack);
...
print('-painters','-r300','-dtiff',['f_short_suppleXX_PVCorr_noRunnoRw_8hz_lightZone_totalPN_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['f_short_suppleXX_PVCorr_noRunnoRw_8hz_lightZone_totalPN_',datestr(now,formatOut),'.ai']);
close;