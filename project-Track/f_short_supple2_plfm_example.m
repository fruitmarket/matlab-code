...
hLightBuild(1) = axes('Position',axpt(5,4,1,1:4,axpt(nCol,nRow,1,1,[0.1 0.1 0.90 0.85],midInterval),midInterval+[0.015 0]));
...
hLightBuild(2) = axes('Position',axpt(5,4,2,1:4,axpt(nCol,nRow,1,1,[0.1 0.1 0.90 0.85],midInterval),midInterval+[0.015 0]));
...
hLightBuild(3) = axes('Position',axpt(5,4,3,1:4,axpt(nCol,nRow,1,1,[0.1 0.1 0.90 0.85],midInterval),midInterval+[0.015 0]));
...
hLightBuild(4) = axes('Position',axpt(5,4,4,1:4,axpt(nCol,nRow,1,1,[0.1 0.1 0.90 0.85],midInterval),midInterval+[0.015 0]));
...
hLightBuild(5) = axes('Position',axpt(5,4,5,1:4,axpt(nCol,nRow,1,1,[0.1 0.1 0.90 0.85],midInterval),midInterval+[0.015 0]));
...
set(hLightBuild,'XLim',winCri_ori,'XTick',[0 20],'YLim',[0, nTrial_ori],'YTick',[]);
