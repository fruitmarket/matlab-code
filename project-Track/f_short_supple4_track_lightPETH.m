...
hold on;
line([sigArea_PNact(1), sigArea_PNact(end)],[7.5,7.5],'color',colorRed,'lineWidth', 2, 'lineStyle','-');
hold on;
...
set(hPlotTrace,'Box','off','TickDIr','out','XLim',[-20,100],'XTick',[-20:20:40,100],'YLim',[-4, 15],'fontSize',fontM);
