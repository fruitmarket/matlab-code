...
load('D:\Dropbox\SNL\P2_Track\neuronList_ori50hz_171229.mat');
% load('D:\Dropbox\SNL\P2_Track\neuronList_ori_171227.mat');
...
% disp('-------------------------------------------------');
% disp(['# of neurons (Run): ',num2str(sum(double(list_pc_Run)))]);
...
% disp('-------------------------------------------------');
% disp(['# of neurons (Rw): ',num2str(sum(double(list_pc_Rw)))]);
% disp(['mean FR (Rw): ',num2str(mean(T.meanFR_task(list_pn_Rw)),3),' Hz']);
% disp(['sem FR (Rw): ',num2str(std(T.meanFR_task(list_pn_Rw))/sqrt(sum(double(list_pn_Rw))),3),' Hz']);
% disp(['mean pv-ratio (Rw): ',num2str(mean(T.spkpvr(list_pn_Rw)),3)]);
% disp(['sem pv-ratio (Rw): ',num2str(std(T.spkpvr(list_pn_Rw))/sqrt(sum(double(list_pn_Rw))),3)]);
% disp(['mean hv-witdh (Rw): ',num2str(mean(T.hfvwth(list_pn_Rw)),3), ' usec']);
% disp(['sem hv-witdh (Rw): ',num2str(std(T.hfvwth(list_pn_Rw))/sqrt(sum(double(list_pn_Rw))),3), ' usec']);