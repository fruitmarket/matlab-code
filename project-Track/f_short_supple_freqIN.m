...
plot_freqDependency_multi(T.path(listPN),T.cellID(listPN),'E:\Dropbox\SNL\P2_Track\example_plfm_freq_v3\pn');
plot_freqDependency_multi(T.path(listIN),T.cellID(listIN),'E:\Dropbox\SNL\P2_Track\example_plfm_freq_v3\in');

% lightAct = listPN & (T.idx_light1hz == 1 | T.idx_light2hz == 1 | T.idx_light8hz == 1 | T.idx_light20hz == 1 | T.idx_light50hz == 1);

lightAct = listIN & (T.idx_light1hz == 1 | T.idx_light2hz == 1 | T.idx_light8hz == 1 | T.idx_light20hz == 1 | T.idx_light50hz == 1);
% lightAct = listIN & (T.idx_light1hz ~= 0 | T.idx_light2hz ~= 0 | T.idx_light8hz ~= 0 | T.idx_light20hz ~= 0 | T.idx_light50hz ~= 0);
