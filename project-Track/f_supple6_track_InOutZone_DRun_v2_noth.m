...
title('In-zone (DRun)','fontSize',fontS,'fontWeight','bold');
...
ylabel('Firing rate (Hz)','fontSize',fontS);
title('Out-zone (DRun)','fontSize',fontS,'fontWeight','bold');
...
print('-painters','-r300','-dtiff',['final_figXX_InOutZone_DRun_v2_noThreshold_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['final_figXX_InOutZone_DRun_v2_noThreshold_',datestr(now,formatOut),'.ai']);
close;