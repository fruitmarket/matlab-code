...
% cellID = [171 172 173 174 193 420]; % for DRun sessions 170928 (inAct, inIn, inNo / outAct, outIn, outNo)
cellID = [171 173 174 193 420 525];
nCell = length(cellID);
...
%     set(hPlot(4),'XLim',[0,124],'XTick',[0:20:120],'YLim',[0, ylimpethSpatial]);
    ...
    cd('D:\Dropbox\SNL\P2_Track\example_track_PF_change_DRun');
