...
text(3,yLimlightBase*0.8,['n = ',num2str(sum(double(total_DRun & T.pLR_Plfm<0.05)))],'FontSize',fontL);
...
text(3,yLimlightTrack*0.8,['n = ',num2str(sum(double(total_DRun & T.pLR_Track<0.05)))],'FontSize',fontL);
ylabel('Spike number','FontSize',fontL);
