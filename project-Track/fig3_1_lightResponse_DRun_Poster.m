...
groupBaseB = total_DRun & T.pLR_Plfm<alpha & (T.statDir_Plfm == -1);
groupBaseC = total_DRun & T.pLR_Plfm<alpha & (T.statDir_Plfm == 0);
groupBaseD = total_DRun & ~(T.pLR_Plfm<alpha) & (T.statDir_Plfm == 1);
groupBaseE = total_DRun & ~(T.pLR_Plfm<alpha) & (T.statDir_Plfm == -1);
groupBaseF = total_DRun & ~(T.pLR_Plfm<alpha) & (T.statDir_Plfm == 0);
basePie = [sum(double(groupBaseA)), sum(double(groupBaseB)), sum(double(total_DRun & ~(T.pLR_Plfm<alpha)))];
...
text(3,yLimlightBase*0.8,['n = ',num2str(sum(double(total_DRun & T.pLR_Plfm<0.05)))],'FontSize',fontM);
...
hold on;
for iCell = 1:sum(double(total_DRun & T.pLR_Track<0.05))
...
text(3,yLimlightTrack*0.8,['n = ',num2str(sum(double(total_DRun & T.pLR_Track<0.05)))],'FontSize',fontM);
ylabel('Spike number','FontSize',fontM);
