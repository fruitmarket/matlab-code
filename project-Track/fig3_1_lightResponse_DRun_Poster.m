...
text(18,18,['Activated neurons (n = ',num2str(sum(histc(latencyBase_Act,0:2:30))),')'],'FontSize',fontM);
text(18,16,['Latency: ',num2str(nanmedian(latencyBase_Act),3),' ms'],'FontSize',fontM);
...
% text(8,18,['Inactivated neurons (n = ',num2str(sum(histc(latencyBase_Inalast,0:2:30))),')'],'FontSize',fontM);
% text(8,16,['1st line: ',num2str(nanmedian(latencyBase_Inalast),3),' ms'],'FontSize',fontM);
% text(8,14,['2nd line: ',num2str(nanmedian(latencyBase_Inafirst),3),' ms'],'FontSize',fontM);
% xlabel('Latency (ms)','FontSize',fontM);
% ylabel('Number of cells','FontSize',fontM);
...
set(hBase(4:6),'XLim',[-10,yLimlightBase],'YLim',[-10,yLimlightBase]);
...
text(18,18,['Activated neurons (n = ',num2str(sum(histc(latencyTrack_Act,0:2:30))),')'],'FontSize',fontM);
text(18,16,['Latency: ',num2str(nanmedian(latencyTrack_Act),3),' ms'],'FontSize',fontM);
xlabel('Latency (ms)','FontSize',fontM);
ylabel('Number of cells','FontSize',fontM);
...
% text(8,18,['Inactivated neuron (n = ',num2str(sum(histc(latencyTrack_Inalast,0:2:30))),')'],'FontSize',fontM);
% text(8,16,['1st line: ',num2str(nanmedian(latencyTrack_Inalast),3),' ms'],'FontSize',fontM);
% text(8,14,['2nd line: ',num2str(nanmedian(latencyTrack_Inafirst),3),' ms'],'FontSize',fontM);
% xlabel('Latency (ms)','FontSize',fontM);
% ylabel('Number of cells','FontSize',fontM);
...
set(hTrack(4:6),'XLim',[-10,yLimlightTrack],'YLim',[-10,yLimlightTrack]);
