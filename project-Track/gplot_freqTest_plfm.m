...
lightCri = T.meanFR<9 & (T.pLR_Plfm1hz<alpha2 | T.pLR_Plfm2hz<alpha2 | T.pLR_Plfm8hz<alpha2 | T.pLR_Plfm20hz<alpha2 | T.pLR_Plfm50hz<alpha2);
...
formatOut = 'yymmdd';
% print('-painters','-r300','-dtiff',['plot_plfm_freqTest_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-depsc',['plot_plfm_laserFreq_',datestr(now,formatOut),'.ai']);
close();
