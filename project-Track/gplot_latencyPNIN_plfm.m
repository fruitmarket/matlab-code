...
DRunPN_actRapid = DRunTN & T.meanFR_task<=cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == 1 & T.latencyPlfm2hz<10;
DRunPN_actDelay = DRunTN & T.meanFR_task<=cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == 1 & T.latencyPlfm2hz>10;
DRunPN_ina = DRunTN & T.meanFR_task<=cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == -1;
DRunPN_no = DRunTN & T.meanFR_task<=cri_meanFR & T.pLR_Plfm2hz>alpha;

DRunIN_actRapid = DRunTN & T.meanFR_task>cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == 1 & T.latencyPlfm2hz<10;
DRunIN_actDelay = DRunTN & T.meanFR_task>cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == 1 & T.latencyPlfm2hz>10;
DRunIN_ina = DRunTN & T.meanFR_task>cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == -1;
DRunIN_no = DRunTN & T.meanFR_task>cri_meanFR & T.pLR_Plfm2hz>alpha;

DRwPN_actRapid = DRwTN & T.meanFR_task<=cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == 1 & T.latencyPlfm2hz<10;
DRwPN_actDelay = DRwTN & T.meanFR_task<=cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == 1 & T.latencyPlfm2hz>10;
DRwPN_ina = DRwTN & T.meanFR_task<=cri_meanFR & T.pLR_Plfm2hz<alpha & T.statDir_Plfm2hz == -1;
...
rectangle('Position',[0,yMaxDRunIN*0.925,10,yMaxDRunIN*0.075],'LineStyle','none','FaceColor',colorBlue);
hold on;
hBarDRunIN(3) = bar(xpt,m_DRunIN_ina_pethPlfm,'histc');
...
set(hPlotDRunPN(1:3),'Box','off','TickDir','out','XLim',[-20 130],'XTick',[-20,0:5:20,130],'YLim',[0, yMaxDRunPN],'fontSize',fontM);
set(hPlotDRunIN(1:3),'Box','off','TickDir','out','XLim',[-20 130],'XTick',[-20,0:5:20,130],'YLim',[0, yMaxDRunIN],'fontSize',fontM);
print('-painters','-r300','plot_latencyPNIN_DRunplfm.tif','-dtiff');
%% DRw
...
set(hPlotDRwPN(1:3),'Box','off','TickDir','out','XLim',[-20 130],'XTick',[-20,0:5:20,130],'YLim',[0, yMaxDRwPN],'fontSize',fontM);
set(hPlotDRwIN(1:3),'Box','off','TickDir','out','XLim',[-20 130],'XTick',[-20,0:5:20,130],'YLim',[0, yMaxDRwIN],'fontSize',fontM);
print('-painters','-r300','plot_latencyPNIN_DRwplfm.tif','-dtiff');
close('all');