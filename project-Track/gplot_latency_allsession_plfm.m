...
latTrack_DRunPN = T.latencyTrack(DRunPN & T.pLR_Track<alpha & T.statDir_Track==1);
latTrack_DRunIN = T.latencyTrack(DRunIN & T.pLR_Track<alpha & T.statDir_Track==1);

latTrack_DRwPN = T.latencyTrack(DRwPN & T.pLR_Track<alpha & T.statDir_Track==1);
latTrack_DRwIN = T.latencyTrack(DRwIN & T.pLR_Track<alpha & T.statDir_Track==1);

latTrack_noRunPN = T.latencyTrack(noRunPN & T.pLR_Track<alpha & T.statDir_Track==1);
latTrack_noRunIN = T.latencyTrack(noRunIN & T.pLR_Track<alpha & T.statDir_Track==1);

latTrack_noRwPN = T.latencyTrack(noRwPN & T.pLR_Track<alpha & T.statDir_Track==1);
latTrack_noRwIN = T.latencyTrack(noRwIN & T.pLR_Track<alpha & T.statDir_Track==1);
%% plot
nCol = 2;
nRow = 4;
