...
[neuDist_DRunPN_total, tracePCA_DRunPN_total, latentPCA_DRunPN_total] = analysis_neuralTrace(T.xptTrackLight(DRunPN_total),15,7,baseLine);    
[neuDist_DRunPN_light, tracePCA_DRunPN_light, latentPCA_DRunPN_light] = analysis_neuralTrace(T.xptTrackLight(DRunPN_light),15,7,baseLine);    
[neuDist_DRunPN_act, tracePCA_DRunPN_act, latentPCA_DRunPN_act] = analysis_neuralTrace(T.xptTrackLight(DRunPN_act),15,7,baseLine);
[neuDist_DRunPN_ina, tracePCA_DRunPN_ina, latentPCA_DRunPN_ina] = analysis_neuralTrace(T.xptTrackLight(DRunPN_ina),15,7,baseLine);
...
plot(tracePCA_DRunPN_total(:,1),tracePCA_DRunPN_total(:,2),'-o','color',colorBlack,'MarkerFaceColor',colorGray,'LineWidth',lineL);
hold on;
plot(tracePCA_DRunPN_light(:,1),tracePCA_DRunPN_light(:,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorGreen,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_light(1,1),tracePCA_DRunPN_light(1,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorLightGreen,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_light(end,1),tracePCA_DRunPN_light(end,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorDarkGreen,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_act(:,1),tracePCA_DRunPN_act(:,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorBlue,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_act(1,1),tracePCA_DRunPN_act(1,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorLightBlue,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_act(end,1),tracePCA_DRunPN_act(end,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorDarkBlue,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_ina(:,1),tracePCA_DRunPN_ina(:,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorRed,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_ina(1,1),tracePCA_DRunPN_ina(1,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorLightRed,'markerEdgeColor',colorBlack);
hold on;
plot(tracePCA_DRunPN_ina(end,1),tracePCA_DRunPN_ina(end,2),'-o','color',colorBlack,'LineWidth',lineL,'MarkerFaceColor',colorDarkRed,'markerEdgeColor',colorBlack);
hold on;
...
print('-painters','-r300','plot_neuralTrace_DRunPN_total.tif','-dtiff');
