...
for iCell = 1:nCell
    ...
    [pre_ratemap, pre_infos, pre_field_info] = compute_rate72x48(pre_visit_map, pre_fr_map, alpha_v, pre_meanrate,...
        fr_threshold, fieldsize_cutoff);
    [stm_ratemap, stm_infos, stm_field_info] = compute_rate72x48(stm_visit_map, stm_fr_map, alpha_v, stm_meanrate,...
        fr_threshold, fieldsize_cutoff);
    [post_ratemap, post_infos, post_field_info] = compute_rate72x48(post_visit_map, post_fr_map, alpha_v, post_meanrate,...
        fr_threshold, fieldsize_cutoff);
