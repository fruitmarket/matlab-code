function plot_Track_sin_8hz_v2
...
%% Heat map
    hMap = axes('Position',axpt(1,5,1,2:5,axpt(nCol,nRow,1:4,7:8,[0.10 0.22 0.85 0.75],tightInterval),wideInterval));
        ...
        text(130,4,[num2str(round(max(peakFR1D_track)*10)/10) ' Hz'],'fontSize',fontS);
        text(42,4.5,'Track heat map','FontSize',fontM,'FontWeight','bold');
