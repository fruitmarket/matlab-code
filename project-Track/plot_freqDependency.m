...
for iCell = 1:nCell
    ...
    switch nSession
        ...
        %% Original 1Hz
            ...
            hLight1hzOri(1) = axes('Position',axpt(nCol,nRow,1,2,figSize,tightInterval));
            hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
            hold on;
            hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
            hold on;
            ...
            hLight1hzOri(2) = axes('Position',axpt(nCol,nRow,1,3,figSize,tightInterval));
        ...
        %% Original 2Hz
            ...
            hLight2hzOri(1) = axes('Position',axpt(nCol,nRow,1,5,figSize,tightInterval));
            hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
            hold on;
            hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
            hold on;
            ...
            hLight2hzOri(2) = axes('Position',axpt(nCol,nRow,1,6,figSize,tightInterval));
            yLim2hzOri = ceil(max(peth2hzConv_ori*1.1)+0.001);
            plot(pethtime2hz_ori,peth2hzConv_ori,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
        ...
        %% Original 8Hz
            hLight8hzOri(1) = axes('Position',axpt(nCol,nRow,1,8,figSize,tightInterval));
            hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
            hold on;
            hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
            hold on;
            ...
            hLight8hzOri(2) = axes('Position',axpt(nCol,nRow,1,9,figSize,tightInterval));
            yLim8hzOri = ceil(max(peth8hzConv_ori*1.1)+0.001);
            plot(pethtime8hz_ori,peth8hzConv_ori,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
        ...
        %% Original 20Hz
            hLight20hzOri(1) = axes('Position',axpt(nCol,nRow,1,11,figSize,tightInterval));
            hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
            hold on;
            hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
            hold on;
            ...
            hLight20hzOri(2) = axes('Position',axpt(nCol,nRow,1,12,figSize,tightInterval));
            yLim20hzOri = ceil(max(peth20hzConv_ori*1.1)+0.001);
            plot(pethtime20hz_ori,peth20hzConv_ori,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
        ...
        %% Original 50Hz
            hLight50hzOri(1) = axes('Position',axpt(nCol,nRow,1,14,figSize,tightInterval));
            hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
            hold on;
            hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
            hold on;
            ...
            hLight50hzOri(2) = axes('Position',axpt(nCol,nRow,1,15,figSize,tightInterval));
            yLim50hzOri = ceil(max(peth50hzConv_ori*1.1)+0.001);
            plot(pethtime50hz_ori,peth50hzConv_ori,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
            ...
            set(hLight50hzOri,'Box','off','TickDir','out','fontSize',fontL);
        %% Each light (1hz)
            hFreq1hz(1) = axes('Position',axpt(nCol,nRow,1:5,1,figSize,tightInterval));
            text(0,0.1,'1hz Stimulation','fontSize',fontXL,'fontWeight','bold');

            hFreq1hz(2) = axes('Position',axpt(nCol,nRow,3:5,2,figSize,tightInterval));
            for iLight = 1:15
            ...
            hFreq1hz(3) = axes('Position',axpt(nCol,nRow,3:5,3,figSize,tightInterval));
            yLim1hz = ceil(max(peth1hzConv)*1.1+0.001);
            plot(pethtime1hz, peth1hzConv,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
            xlabel('Time (ms)','FontSize',fontL);

            set(hFreq1hz(1),'visible','off');
            set(hFreq1hz(2),'XLim',win1hz,'XTick',[],'YLim',[0, nTrial],'YTick',[0, nTrial],'YTickLabel',{0, nTrial});
            set(hFreq1hz(3), 'XLim', win1hz, 'XTick', [0:3000:win1hz(2)],'YLim', [0 yLim1hz], 'YTick', [0 yLim1hz], 'YTickLabel', {[], yLim1hz});
            set(hFreq1hz,'Box','off','TickDir','out','fontSize',fontL);
            
        %% Each light (2hz)
            hFreq2hz(1) = axes('Position',axpt(nCol,nRow,1:5,4,figSize,tightInterval));
            text(0,0.1,'2hz Stimulation','fontSize',fontXL,'fontWeight','bold');

            hFreq2hz(2) = axes('Position',axpt(nCol,nRow,3:5,5,figSize,tightInterval));
            for iLight = 1:15
                hLBar(1) = rectangle('Position',[500*iLight-500, 0, 10, nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
                hold on;
                hLBar(2) = rectangle('Position',[500*iLight-500, 18, 10, nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
            ...
            hFreq2hz(3) = axes('Position',axpt(nCol,nRow,3:5,6,figSize,tightInterval));
            yLim2hz = ceil(max(peth2hzConv)*1.1+0.001);
            plot(pethtime2hz, peth2hzConv,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
            xlabel('Time (ms)','FontSize',fontL);
            ...
            set(hFreq2hz(1),'visible','off');
            set(hFreq2hz(2),'XLim',win2hz,'XTick',[],'YLim',[0, nTrial],'YTick',[0, nTrial],'YTickLabel',{0, nTrial});
            set(hFreq2hz(3), 'XLim', win2hz, 'XTick', [0:2000:win2hz(2)],'YLim', [0 yLim2hz], 'YTick', [0 yLim2hz], 'YTickLabel', {[], yLim2hz});
            set(hFreq2hz,'Box','off','TickDir','out','fontSize',fontL);

        %% Each light (8Hz)
            hFreq8hz(1) = axes('Position',axpt(nCol,nRow,1:5,7,figSize,tightInterval));
            text(0,0.1,'8hz Stimulation','fontSize',fontXL,'fontWeight','bold');

            hFreq8hz(2) = axes('Position',axpt(nCol,nRow,3:5,8,figSize,tightInterval));
            for iLight = 1:15
                hold on;
                hLBar(1) = rectangle('Position',[125*iLight-125, 0, 10, 20],'LineStyle','none','FaceColor',colorLLightBlue);
                hold on;
            ...
            hFreq8hz(3) = axes('Position',axpt(nCol,nRow,3:5,9,figSize,tightInterval));
            yLim8hz = ceil(max(peth8hzConv)*1.1+0.001);
            plot(pethtime8hz,peth8hzConv,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
            xlabel('Time (ms)','FontSize',fontL);
        ...
        %% Each light (20Hz)
            hFreq20hz(1) = axes('Position',axpt(nCol,nRow,1:5,10,figSize,tightInterval));
            text(0,0.1,'20hz Stimulation','fontSize',fontXL,'fontWeight','bold');

            hFreq20hz(2) = axes('Position',axpt(nCol,nRow,3:5,11,figSize,tightInterval));
            for iLight = 1:15
                hold on;
                hLBar(1) = rectangle('Position',[50*iLight-50, 0, 10, 20],'LineStyle','none','FaceColor',colorLLightBlue);
                hold on;
            ...
            hFreq20hz(3) = axes('Position',axpt(nCol,nRow,3:5,12,figSize,tightInterval));
            yLim20hz = ceil(max(peth20hzConv)*1.1+0.001);
            plot(pethtime20hz,peth20hzConv,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
            xlabel('Time (ms)','FontSize',fontL);
        ...
        %% Each light (50Hz)
            hFreq50hz(1) = axes('Position',axpt(nCol,nRow,1:5,13,figSize,tightInterval));
            text(0,0.1,'50hz Stimulation','fontSize',fontXL,'fontWeight','bold');

            hFreq50hz(2) = axes('Position',axpt(nCol,nRow,3:5,14,figSize,tightInterval));
            for iLight = 1:15
                hold on;
                hLBar(1) = rectangle('Position',[20*iLight-20, 0, 10, 20],'LineStyle','none','FaceColor',colorLLightBlue);
                hold on;
            ...
            hFreq50hz(3) = axes('Position',axpt(nCol,nRow,3:5,15,figSize,tightInterval));
            yLim50hz = ceil(max(peth50hzConv)*1.1+0.001);
            plot(pethtime50hz,peth50hzConv,'LineStyle','-','LineWidth',lineM,'Color',colorBlack);
            xlabel('Time (ms)','FontSize',fontL);
