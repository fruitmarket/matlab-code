function plot_freqDependency_single
...
%% waveform
    ...
    for iCh = 1:4
        hWaveform(iCh) = axes('Position',axpt(4,2,iCh,1,axpt(nCol,nRow,1:2,1,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% text information
    hText = axes('Position',axpt(1,1,1,1,axpt(nCol,nRow,3:4,1,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    ...
    hPvalue(1) = axes('Position',axpt(nCol,nRow,5,2,[0.1 0.1 0.80 0.80],midInterval));
    text(0.1,0.5,['p-value: ',num2str(pLR_Plfm1hz,3)],'fontSize',fontL);
    hPvalue(2) = axes('Position',axpt(nCol,nRow,5,3,[0.1 0.1 0.80 0.80],midInterval));
    text(0.1,0.5,['p-value: ',num2str(pLR_Plfm2hz,3)],'fontSize',fontL);
    hPvalue(3) = axes('Position',axpt(nCol,nRow,5,4,[0.1 0.1 0.80 0.80],midInterval));
    text(0.1,0.5,['p-value: ',num2str(pLR_Plfm8hz,3)],'fontSize',fontL);
    hPvalue(4) = axes('Position',axpt(nCol,nRow,5,5,[0.1 0.1 0.80 0.80],midInterval));
    text(0.1,0.5,['p-value: ',num2str(pLR_Plfm20hz,3)],'fontSize',fontL);
    hPvalue(5) = axes('Position',axpt(nCol,nRow,5,6,[0.1 0.1 0.80 0.80],midInterval));
    text(0.1,0.5,['p-value: ',num2str(pLR_Plfm50hz,3)],'fontSize',fontL);
    set(hPvalue,'visible','off');

%% Original 1Hz
    hLight1hzOri(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,1,2,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    ...
    hLight1hzOri(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,1,2,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Original 2Hz
    hLight2hzOri(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,1,3,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
    hold on;
    hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
    hold on;
    ...
    hLight2hzOri(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,1,3,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Original 8Hz
    hLight8hzOri(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,1,4,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
    hold on;
    hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
    hold on;
    ...
    hLight8hzOri(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,1,4,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Original 20Hz
    hLight20hzOri(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,1,5,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
    hold on;
    hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
    hold on;
    ...
    hLight20hzOri(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,1,5,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Original 50Hz
    hLight50hzOri(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,1,6,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    hLBar(1) = rectangle('Position',[0,0,10,nTrial_ori],'LineStyle','none','FaceColor',colorLLightBlue);
    hold on;
    hLBar(2) = rectangle('Position',[0,270,10,nTrial_ori/10],'LineStyle','none','FaceColor',colorBlue);
    hold on;
    ...
    hLight50hzOri(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,1,6,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Each light (1hz)
    hFreq1hz(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,2:4,2,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    for iLight = 1:15
    ...
    hFreq1hz(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,2:4,2,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Each light (2hz)
    hFreq2hz(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,2:4,3,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    for iLight = 1:15
    ...
    hFreq2hz(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,2:4,3,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Each light (8Hz)
    hFreq8hz(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,2:4,4,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    for iLight = 1:15
        hold on;
    ...
    hFreq8hz(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,2:4,4,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Each light (20Hz)
    hFreq20hz(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,2:4,5,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    for iLight = 1:15
        hold on;
    ...
    hFreq20hz(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,2:4,5,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Each light (50Hz)
    hFreq50hz(1) = axes('Position',axpt(1,2,1,1,axpt(nCol,nRow,2:4,6,[0.1 0.1 0.80 0.80],midInterval),midInterval));
    for iLight = 1:15
        hold on;
    ...
    hFreq50hz(2) = axes('Position',axpt(1,2,1,2,axpt(nCol,nRow,2:4,6,[0.1 0.1 0.80 0.80],midInterval),midInterval));
...
%% Light probability
    hFrequency = axes('Position',axpt(1,1,1,1,axpt(nCol,nRow,1:2,7,[0.1 0.05 0.80 0.90],midInterval),midInterval));
    ...
    set(hFrequency,'XLim',[0,6],'XTick',1:5,'XTickLabel',{'1 hz'; '2 hz'; '8 hz'; '20 hz'; '50 hz'},'YLim',[0,50]);
