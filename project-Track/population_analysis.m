...
for iFile = 1:nFile
    load(cellList{iFile},'fr_base','fr_task','burstIdx','spkwv','spkwth','hfvwth','p_tag','p_modu','p_saltTag','p_saltModu',...
    ...
    temT = table(mouseLine,taskType,cellList(iFile),taskProb,fr_base,fr_task,burstIdx,{spkwv},spkwth,hfvwth,p_tag,p_modu,p_saltTag,p_saltModu,...
        tagRatio,moduRatio,ntagLightspk,nmoduLightspk,lightDir_tag,lightDir_modu,latency_tag,latency_modu,...
        r_Corrbfxaft,r_Corrbfxdr,r_Corrdrxaft,r_Corrhfxhf,p_Corrbfxaft,p_Corrbfxdr,p_Corrdrxaft,p_Corrhfxhf,...
...
save(['cellList_Nolight_100.mat'],'T');
clear T cellList nFile;