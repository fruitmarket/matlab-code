...
%         statDir_Track2(1,iRepeat) = temp_statDir_Track;
%         latencyPlfm2(1,iRepeat) = temp_latencyPlfm;
%         latencyTrack2(1,iRepeat) = temp_latencyTrack;
%     end
%% Log-rank test
%%% Moving win %%%
    movingWin = (0:2:18)';
