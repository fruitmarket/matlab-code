function tagstatTrack_v3(sessionFolder)
%tagstatCC calculates statistical significance using log-rank test

% Variables for log-rank test & salt test
dt = 0.1;
testRangePlfm = 20; % unit: ms 
baseRangePlfm = 475; % baseline 
testRangeTrack = 20; % 8Hz: 10 // 20Hz: 20
...
% Salt test
    [pSaltPlfm, lSaltPlfm] = saltTest(timePlfm, testRangePlfm, dt);
    [pSaltTrack, lSaltTrack] = saltTest(timeTrack, testRangeTrack, dt);
