...
set(hPlotDRunPN(1:3),'Box','off','TickDir','out','XLim',[-20 100],'XTick',[-20,0:5:20,100],'YLim',[0, yMaxDRunPN],'fontSize',fontM);
set(hPlotDRunPN(4),'Box','off','TickDir','out','XLim',[-20 100],'XTick',[-20,0:5:20,100],'YLim',[0, yMaxDRunPN],'fontSize',fontM);
set(hPlotDRunPN(5),'Box','off','TickDir','out','XLim',[-20 100],'XTick',[-20,0:5:20,100],'YLim',[0, 10],'fontSize',fontM);
set(hPlotDRunIN(1:3),'Box','off','TickDir','out','XLim',[-20 100],'XTick',[-20,0:5:20,100],'YLim',[0, yMaxDRunIN],'fontSize',fontM);
set(hPlotDRunIN(4),'Box','off','TickDir','out','XLim',[-20 100],'XTick',[-20,0:5:20,100],'YLim',[0, yMaxDRunIN],'fontSize',fontM);
