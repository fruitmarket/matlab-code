...
xlabel('Time (ms)','fontSize',fontL);
ylabel('Spikes/bin','fontSize',fontL);
title('PN_Rapid activated','fontSize',fontL,'interpreter','none','fontWeight','bold');
...
xlabel('Time (ms)','fontSize',fontL);
ylabel('Spikes/bin','fontSize',fontL);
title('PN_Delay activated','fontSize',fontL,'interpreter','none','fontWeight','bold');
...
text(15, yMaxPN*0.8,['n = ',num2str(ninactPN)],'fontSize',fontL);
xlabel('Time (ms)','fontSize',fontL);
ylabel('Spikes/bin','fontSize',fontL);
...
text(15, yMaxPN*0.8,['n = ',num2str(nnoPN)],'fontSize',fontL);
xlabel('Time (ms)','fontSize',fontL);
ylabel('Spikes/bin','fontSize',fontL);
...
set(hPlotPN,'Box','off','TickDir','out','XLim',[0,20],'XTick',[0:5:20],'YLim',[0,yMaxPN],'fontSize',fontL);
set(hPlotPN(4),'YLim',[0 100],'fontSize',fontL);
%% IN
