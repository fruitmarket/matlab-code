...
hPlot(2) = axes('Position',axpt(nCol,nRow,1,2,spaceFig,wideInterval));
    ...
    text(100,yLim(2)*0.8,['n = ',num2str(n_ca3a_dir)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);
...
hPlot(3) = axes('Position',axpt(nCol,nRow,1,3,spaceFig,wideInterval));
    ...
    text(100,yLim(3)*0.8,['n = ',num2str(n_ca3a_ind)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);
...
hPlot(4) = axes('Position',axpt(nCol,nRow,1,4,spaceFig,wideInterval));
    ...
    text(100,yLim(4)*0.8,['n = ',num2str(n_ca3a_rest)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);
...
hPlot(5) = axes('Position',axpt(nCol,nRow,1,5,spaceFig,wideInterval));
    ...
    text(100,yLim(5)*0.8,['n = ',num2str(n_ca3a_inh)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);
...
hPlot(6) = axes('Position',axpt(nCol,nRow,1,6,spaceFig,wideInterval));
    ...
    text(100,yLim(6)*0.8,['n = ',num2str(n_ca3a_non)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);

set(hPlot(1),'YLim',[0 yLim(1)],'YTick',[0:20:yLim(1)]);
set(hPlot(2),'YLim',[0 yLim(2)],'YTick',[0:40:yLim(2)]);
set(hPlot(3),'YLim',[0 yLim(3)],'YTick',[0:15:yLim(3)]);
set(hPlot(4),'YLim',[0 yLim(4)]);
set(hPlot(5),'YLim',[0 yLim(5)]);
set(hPlot(6),'YLim',[0 yLim(6)]);

%%
yLim_bc = [100 120, 10, 5];
...
hPlot(8) = axes('Position',axpt(nCol,nRow,2,2,spaceFig,wideInterval));
    ...
    text(100,yLim_bc(2)*0.8,['n = ',num2str(n_ca3bc_dir)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);
...
hPlot(9) = axes('Position',axpt(nCol,nRow,2,4,spaceFig,wideInterval));
    ...
    text(100,yLim_bc(3)*0.8,['n = ',num2str(n_ca3bc_rest)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);
...
hPlot(10) = axes('Position',axpt(nCol,nRow,2,6,spaceFig,wideInterval));
    ...
    text(100,yLim_bc(4)*0.8,['n = ',num2str(n_ca3bc_non)],'fontSize',fontM);
    xlabel('Time (ms)','fontSize',fontM);
    ylabel('Rate (Hz)','fontSize',fontM);
...
set(hPlot(9),'YLim',[0 yLim_bc(3)],'YTick',[0:5:yLim_bc(3)]);
set(hPlot(10),'YLim',[0 yLim_bc(4)]);

print('-painters','-r300','-dtiff',['fig4_PSTH_novel_',datestr(now,formatOut),'.tif']);
print('-painters','-r300','-deps',['fig4_PSTH_novel_',datestr(now,formatOut),'.ai']);
close all;