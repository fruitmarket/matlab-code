...
% saveDir = 'E:\Dropbox\SNL\P4_FamiliarNovel\example_novel\raster_dir_190113';
% path = path_dir;
% cellID = T.cellID(neuron_dir);

% saveDir = 'E:\Dropbox\SNL\P4_FamiliarNovel\example_novel\raster_ind_190113';
% path = path_ind;
% cellID = T.cellID(neuron_ind);

% saveDir = 'E:\Dropbox\SNL\P4_FamiliarNovel\example_novel\raster_doub_190113';
% path = path_doub;
% cellID = T.cellID(neuron_doub);

saveDir = 'E:\Dropbox\SNL\P4_FamiliarNovel\example_novel\raster_inh_190113';
path = path_inh;
...
for iCell = 1:nCell
    ...
    for iLight = 1:nTrain
        patch([20*(iLight-1) 20*(iLight-1)+10 20*(iLight-1)+10 20*(iLight-1)],[0,0,nBurst,nBurst],colorLLightBlue,'LineStyle','none');
        hold on;
    end
    ...
    set(hRaster,'Box','off','TickDir','out','fontSize',fontS,'fontName',fontStyle,'XLim',[-10,100],'XTick',[],'YLim',[0,nBurst],'YTick',[0,nBurst]);
    ...
    align_ylabel([hRaster, hPETH],1.2,0);
    cd(saveDir);
