...
hBar(4) = bar(xpt,m_peth_th_inh,'histc');
...
hBar(5) = bar(xpt,m_peth_th_non,'histc');
...
cd(rtDir);
print('-painters','-r300','-dtiff',['plot_familiar_lightResponse_all_',datestr(now,formatOut),'.tif']);
close all;