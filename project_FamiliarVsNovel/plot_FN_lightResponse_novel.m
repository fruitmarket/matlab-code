...
load('E:\Dropbox\SNL\P4_FamiliarNovel\P2_Track\myParameters.mat');
formatOut = 'yymmdd';
...
set(hPlot(2),'YLim',[0 yLim(2)],'YTick',[0:20:yLim(2)]);
set(hPlot(3),'YLim',[0 yLim(3)],'YTick',[0:20:yLim(3)]);
set(hPlot(4),'YLim',[0 yLim(4)],'YTick',[0:5:15]);
set(hPlot(5),'YLim',[0 yLim(5)],'YTick',[0:5:10]);

cd(rtDir);
print('-painters','-r300','-dtiff',['plot_novel_lightResponse_all_',datestr(now,formatOut),'.tif']);
close all;