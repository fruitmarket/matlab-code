...
%     hold on;
% end
% hBar(2) = bar(xpt,m_peth_inh,'histc');
...
hBar(2) = bar(xpt,m_peth_non,'histc');
...
hBar(2) = bar(xpt,m_peth_th_non,'histc');
...
cd(rtDir);
print('-painters','-r300','-dtiff',['plot_novel_lightResponse_CA3bc_',datestr(now,formatOut),'.tif']);
close all;