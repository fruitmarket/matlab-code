...
rewardLoc2 = [20*pi*9/6 20*pi*10/6]+[2, -2];
    ...
    hPlot(1) = axes('Position',axpt(13,3,1:11,1,[0.2 0.17 0.85 0.80],[0.01 0.1]));
        plot([xpt1stLPre{1};xpt1stLStm{1};xpt1stLPost{1}],[ypt1stLPre{1};30+ypt1stLStm{1};60+ypt1stLPost{1}],'Marker','.','MarkerSize',markerS,'color',colorBlack,'markerFaceColor',colorBlack,'markerEdgeColor',colorBlack);
    ...
    hPlot(2) = axes('Position',axpt(13,3,1:11,2,[0.2 0.07 0.85 0.80],[0.01 0.1]));
        plot([xptSpatial{1};xptSpatial{2};xptSpatial{3}],[yptSpatial{1};yptSpatial{2};yptSpatial{3}],'Marker','.','MarkerSize',markerS,'color',colorBlack,'markerFaceColor',colorBlack,'markerEdgeColor',colorBlack);
        ...
        text(95, 100,[num2str(round(max(peakFR1D_track)*10)/10) ' Hz'],'fontSize',fontM);
        ylabel('Lap','FontSize',fontM);
        uistack(pLight,'bottom');
        uistack(pRw,'bottom');
